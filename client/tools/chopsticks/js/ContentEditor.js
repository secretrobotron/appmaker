Chopsticks.contentEditor = {}

/**
 * Fires when a block being edited a blur occurs.
 */
Chopsticks.contentEditor.onblur = function () {
  
  var scrap = $(this).scrap()
  scrap.set('content', $(this).html())

  // rebind the blocks
  $(this).off('tap mousedown slide slidestart hold slideend', Chopsticks.contentEditor.killEvent)
 ...
 */
Chopsticks.contentEditor.focus = function (selector, selectAll) {
  ...
  element.on('tap slide slidestart hold slideend', Chopsticks.contentEditor.killEvent)
  
  // on blur, remove all this stuff.
  element.on('blur', Chopsticks.contentEditor.onblur)
 ...
 * @return false.
 */
Chopsticks.contentEditor.killEvent = function (event) {
  // 
  Chopsticks.Mouse.down.stopPropagation()
  return false
}
