...
$.fn.duplicate = function () {
  ...
  var id = $(this).attr('id')
  var parent = Boston.page
  var path = $(this).parentPath()
  if (path) {
    parent = Boston.page.get(path)
    path = path.replace(/ scraps/g,'') + ' '
  }
  var key = Boston.autokey(parent, id)
...
$.fn.owner = function () {
  return Boston.page.get($(this).attr('value')).element()
}
...
$.fn.scrap = function () {
  return Boston.page.get($(this).attr('path'))
}
...
$.fn.selectMe = function (quiet) {
  ...
  Boston.MoveHandle.create(scrap)
  
  if (!quiet)
    Boston.trigger('selection')

  Boston.EditHandle.create(scrap)
  ...
  if (fixed) {
    Boston.StretchHandle.create(scrap, "middle", "left", fixed)
    Boston.StretchHandle.create(scrap, "middle", "right", fixed)
    return this
  }
  
  // Everything can be resized
  Boston.StretchHandle.create(scrap, "top", "left")
  Boston.StretchHandle.create(scrap, "top", "center")
  Boston.StretchHandle.create(scrap, "top", "right")
  Boston.StretchHandle.create(scrap, "middle", "left")
  Boston.StretchHandle.create(scrap, "middle", "right")
  Boston.StretchHandle.create(scrap, "bottom", "left")
  Boston.StretchHandle.create(scrap, "bottom", "center")
  Boston.StretchHandle.create(scrap, "bottom", "right")
