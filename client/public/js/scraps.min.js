...
Scrap.prototype.setContent=function(){this.get("content")&&this.div.html(this.get("content"));if(this.values.styles&&this.values.styles instanceof Space){var a=this.div;this.values.styles.each(function(b,c){a.html(Scrap.styleToCss(b,c.values))})}var b=this.get("scraps");if(b){var c=this;b.each(function(a,b){c.div.html(b.toHtml())})}return this};Scrap.prototype.setTag=function(){tag=this.values.tag?this.values.tag:"div";this.div=new Element(tag)};
...
Page.prototype=new Space;Page.prototype.clone=function(){return new Page(this.values)};Page.prototype.loadScraps=function(){var a=this;this.each(function(b,c){a._set(b,new Scrap(b,c))})};Page.prototype.toHtml=function(a){var b="<!doctype html>\n<html>";this.each(function(c,d){b+="\n  "+d.toHtml(a)});return b+="\n</html>"};"undefined"!==typeof exports&&(module.exports=Page);
