...
AppMaker.qrCode=function(){ImagePreview('<div id="qrCode"><div id="AppMakerManifestLink">'+("http://"+document.location.host+"/install.html")+"</div>");new QRCode("qrCode",{text:"http://"+document.location.host+"/",width:512,height:512,colorDark:"#000000",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.H})};AppMaker.shortcuts={};AppMaker.shortcuts.backspace=function(){$(".ui-selected").remove()};AppMaker.shortcuts["delete"]=function(){$(".ui-selected").remove()};var Blog=new Tool("Blog");
