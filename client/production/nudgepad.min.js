...
return a}function s(a,b,d){if(b=b||0,h.isFunction(b))return h.grep(a,function(a,R){return!!b.call(a,R,a)===d});if(b.nodeType)return h.grep(a,function(a){return a===b===d});if("string"==typeof b){var c=h.grep(a,function(a){return 1===a.nodeType});if(Rc.test(b))return h.filter(b,c,!d);b=h.filter(b,c)}return h.grep(a,function(a){return 0<=h.inArray(a,b)===d})}function w(a){var b=qc.split("|");a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function v(a){var b=
a.getAttributeNode("type");return a.type=(b&&b.specified)+"/"+a.type,a}function r(a){var b=Sc.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function G(a,b){for(var d,c=0;null!=(d=a[c]);c++)h._data(d,"globalEval",!b||h._data(b[c],"globalEval"))}function A(a,b){if(1===b.nodeType&&h.hasData(a)){var d,c,e;c=h._data(a);var f=h._data(b,c),g=c.events;if(g)for(d in delete f.handle,f.events={},g){c=0;for(e=g[d].length;e>c;c++)h.event.add(b,d,g[d][c])}f.data&&(f.data=h.extend({},f.data))}}function n(a,
d){var c,e,f=0,g=typeof a.getElementsByTagName!==U?a.getElementsByTagName(d||"*"):typeof a.querySelectorAll!==U?a.querySelectorAll(d||"*"):b;if(!g){g=[];for(c=a.childNodes||a;null!=(e=c[f]);f++)!d||h.nodeName(e,d)?g.push(e):h.merge(g,n(e,d))}return d===b||d&&h.nodeName(a,d)?h.merge([a],g):g}function N(a){ac.test(a.type)&&(a.defaultChecked=a.checked)}function x(a,b){if(b in a)return b;for(var d=b.charAt(0).toUpperCase()+b.slice(1),c=b,e=rc.length;e--;)if(b=rc[e]+d,b in a)return b;return c}function B(a,
b){return a=b||a,"none"===h.css(a,"display")||!h.contains(a.ownerDocument,a)}function C(a,b){for(var d,c,e,f=[],g=0,p=a.length;p>g;g++)c=a[g],c.style&&(f[g]=h._data(c,"olddisplay"),d=c.style.display,b?(f[g]||"none"!==d||(c.style.display=""),""===c.style.display&&B(c)&&(f[g]=h._data(c,"olddisplay",J(c.nodeName)))):f[g]||(e=B(c),(d&&"none"!==d||!e)&&h._data(c,"olddisplay",e?d:h.css(c,"display"))));for(g=0;p>g;g++)c=a[g],c.style&&(b&&"none"!==c.style.display&&""!==c.style.display||(c.style.display=b?
f[g]||"":"none"));return a}function l(a,b,c){return(a=Tc.exec(b))?Math.max(0,a[1]-(c||0))+(a[2]||"px"):b}function z(a,b,c,d,e){b=c===(d?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===c&&(f+=h.css(a,c+ab[b],!0,e)),d?("content"===c&&(f-=h.css(a,"padding"+ab[b],!0,e)),"margin"!==c&&(f-=h.css(a,"border"+ab[b]+"Width",!0,e))):(f+=h.css(a,"padding"+ab[b],!0,e),"padding"!==c&&(f+=h.css(a,"border"+ab[b]+"Width",!0,e)));return f}function O(a,b,c){var d=!0,e="width"===b?a.offsetWidth:
a.offsetHeight,f=bb(a),g=h.support.boxSizing&&"border-box"===h.css(a,"boxSizing",!1,f);if(0>=e||null==e){if(e=cb(a,b,f),(0>e||null==e)&&(e=a.style[b]),Mb.test(e))return e;d=g&&(h.support.boxSizingReliable||e===a.style[b]);e=parseFloat(e)||0}return e+z(a,b,c||(g?"border":"content"),d,f)+"px"}function J(a){var b=D,c=sc[a];return c||(c=X(a,b),"none"!==c&&c||(Db=(Db||h("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(Db[0].contentWindow||
...
var d,e=0,f=b.toLowerCase().match(ya)||[];if(h.isFunction(c))for(;d=f[e++];)"+"===d[0]?(d=d.slice(1)||"*",(a[d]=a[d]||[]).unshift(c)):(a[d]=a[d]||[]).push(c)}}function Y(a,c,d,e){function f(j){var k;return g[j]=!0,h.each(a[j]||[],function(a,R){var h=R(c,d,e);return"string"!=typeof h||p||g[h]?p?!(k=h):b:(c.dataTypes.unshift(h),f(h),!1)}),k}var g={},p=a===bc;return f(c.dataTypes[0])||!g["*"]&&f("*")}function ca(a,c){var d,e,f=h.ajaxSettings.flatOptions||{};for(e in c)c[e]!==b&&((f[e]?a:d||(d={}))[e]=
c[e]);return d&&h.extend(!0,a,d),a}function S(){try{return new a.XMLHttpRequest}catch(R){}}function Z(){return setTimeout(function(){kb=b}),kb=h.now()}function F(a,b,c){var d,e,f=0,g=Nb.length,p=h.Deferred().always(function(){delete j.elem}),j=function(){if(e)return!1;for(var b=kb||Z(),b=Math.max(0,k.startTime+k.duration-b),c=1-(b/k.duration||0),d=0,da=k.tweens.length;da>d;d++)k.tweens[d].run(c);return p.notifyWith(a,[k,c,b]),1>c&&da?b:(p.resolveWith(a,[k]),!1)},k=p.promise({elem:a,props:h.extend({},
...
h.isArray(d)&&(l=d[1],d=b[u]=d[0]),u!==q&&(b[q]=d,delete b[u]),n=h.cssHooks[q],n&&"expand"in n)for(u in d=n.expand(d),delete b[q],d)u in b||(b[u]=d[u],c[u]=l);else c[q]=l;for(;g>f;f++)if(d=Nb[f].call(k,a,b,k.opts))return d;var E=k;h.each(b,function(a,R){for(var b=(Eb[a]||[]).concat(Eb["*"]),c=0,d=b.length;d>c&&!b[c].call(E,a,R);c++);});return h.isFunction(k.opts.start)&&k.opts.start.call(a,k),h.fx.timer(h.extend(j,{elem:a,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,k.opts.complete).fail(k.opts.fail).always(k.opts.always)}
function L(a,b,c,d,e){return new L.prototype.init(a,b,c,d,e)}function q(a,b){var c,d={height:a},e=0;for(b=b?1:0;4>e;e+=2-b)c=ab[e],d["margin"+c]=d["padding"+c]=a;return b&&(d.opacity=d.width=a),d}function I(a){return h.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var E,y,U=typeof b,D=a.document,oa=a.location,Ua=a.jQuery,Va=a.$,pa={},za=[],ba=za.concat,qa=za.push,fa=za.slice,P=za.indexOf,ma=pa.toString,M=pa.hasOwnProperty,lb="1.9.1".trim,h=function(a,b){return new h.fn.init(a,b,y)},
Aa=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,ya=/\S+/g,Wa=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,db=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,eb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Fb=/^[\],:{}\s]*$/,Ob=/(?:^|:|,)(?:\s*\[)+/g,Pa=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,mb=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Ia=/^-ms-/,Gb=/-([\da-z])/gi,Pb=function(a,b){return b.toUpperCase()},H=function(a){(D.addEventListener||"load"===a.type||"complete"===D.readyState)&&(Qa(),h.ready())},Qa=function(){D.addEventListener?
(D.removeEventListener("DOMContentLoaded",H,!1),a.removeEventListener("load",H,!1)):(D.detachEvent("onreadystatechange",H),a.detachEvent("onload",H))};h.fn=h.prototype={jquery:"1.9.1",constructor:h,init:function(a,c,d){var e,f;if(!a)return this;if("string"==typeof a){if(e="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:db.exec(a),!e||!e[1]&&c)return!c||c.jquery?(c||d).find(a):this.constructor(c).find(a);if(e[1]){if(c=c instanceof h?c[0]:c,h.merge(this,h.parseHTML(e[1],c&&
...
try{if(a.constructor&&!M.call(a,"constructor")&&!M.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(c){return!1}for(var d in a);return d===b||M.call(a,d)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1);b=b||D;var d=eb.exec(a);c=!c&&[];return d?[b.createElement(d[1])]:(d=h.buildFragment([a],b,c),c&&h(c).remove(),h.merge([],d.childNodes))},parseJSON:function(R){return a.JSON&&
a.JSON.parse?a.JSON.parse(R):null===R?R:"string"==typeof R&&(R=h.trim(R),R&&Fb.test(R.replace(Pa,"@").replace(mb,"]").replace(Ob,"")))?Function("return "+R)():(h.error("Invalid JSON: "+R),b)},parseXML:function(R){var c,d;if(!R||"string"!=typeof R)return null;try{a.DOMParser?(d=new DOMParser,c=d.parseFromString(R,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(R))}catch(e){c=b}return c&&c.documentElement&&!c.getElementsByTagName("parsererror").length||h.error("Invalid XML: "+
R),c},noop:function(){},globalEval:function(b){b&&h.trim(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(Ia,"ms-").replace(Gb,Pb)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,c){var e,h=0,f=a.length,g=d(a);if(c)if(g)for(;f>h&&!(e=b.apply(a[h],c),!1===e);h++);else for(h in a){if(e=b.apply(a[h],c),!1===e)break}else if(g)for(;f>h&&!(e=b.call(a[h],h,a[h]),!1===e);h++);else for(h in a)if(e=b.call(a[h],
h,a[h]),!1===e)break;return a},trim:lb&&!lb.call("\ufeff\u00a0")?function(a){return null==a?"":lb.call(a)}:function(a){return null==a?"":(a+"").replace(Wa,"")},makeArray:function(a,b){var c=b||[];return null!=a&&(d(Object(a))?h.merge(c,"string"==typeof a?[a]:a):qa.call(c,a)),c},inArray:function(a,b,c){var d;if(b){if(P)return P.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;d>c;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,c){var d=c.length,e=a.length,h=0;if("number"==typeof d)for(;d>
...
this,d.concat(fa.call(arguments)))},e.guid=a.guid=a.guid||h.guid++,e):b},access:function(a,c,d,e,f,g,p){var j=0,k=a.length,q=null==d;if("object"===h.type(d))for(j in f=!0,d)h.access(a,c,j,d[j],!0,g,p);else if(e!==b&&(f=!0,h.isFunction(e)||(p=!0),q&&(p?(c.call(a,e),c=null):(q=c,c=function(a,b,c){return q.call(h(a),c)})),c))for(;k>j;j++)c(a[j],d,p?e:e.call(a[j],j,c(a[j],d)));return f?a:q?c.call(a):k?c(a[0],d):g},now:function(){return(new Date).getTime()}});h.ready.promise=function(b){if(!E)if(E=h.Deferred(),
"complete"===D.readyState)setTimeout(h.ready);else if(D.addEventListener)D.addEventListener("DOMContentLoaded",H,!1),a.addEventListener("load",H,!1);else{D.attachEvent("onreadystatechange",H);a.attachEvent("onload",H);var c=!1;try{c=null==a.frameElement&&D.documentElement}catch(d){}c&&c.doScroll&&function Qc(){if(!h.isReady){try{c.doScroll("left")}catch(a){return setTimeout(Qc,50)}Qa();h.ready()}}()}return E.promise(b)};h.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(a,b){pa["[object "+b+"]"]=b.toLowerCase()});y=h(D);var Ra={};h.Callbacks=function(a){var c;if("string"==typeof a){if(!(c=Ra[a])){c=a;var d=Ra[c]={};c=(h.each(c.match(ya)||[],function(a,b){d[b]=!0}),d)}}else c=h.extend({},a);a=c;var e,f,g,p,j,k,q=[],u=!a.once&&[],l=function(b){f=a.memory&&b;g=!0;j=k||0;k=0;p=q.length;for(e=!0;q&&p>j;j++)if(!1===q[j].apply(b[0],b[1])&&a.stopOnFalse){f=!1;break}e=!1;q&&(u?u.length&&l(u.shift()):f?q=[]:n.disable())},n={add:function(){if(q){var b=q.length;(function Vc(b){h.each(b,
...
"fx",[])},promise:function(a,c){var d,e=1,f=h.Deferred(),g=this,p=this.length,j=function(){--e||f.resolveWith(g,[g])};"string"!=typeof a&&(c=a,a=b);for(a=a||"fx";p--;)(d=h._data(g[p],a+"queueHooks"))&&d.empty&&(e++,d.empty.add(j));return j(),f.promise(c)}});var ua,sa,p=/[\t\r\n]/g,u=/\r/g,ha=/^(?:input|select|textarea|button|object)$/i,Ca=/^(?:a|area)$/i,nb=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,ob=/^(?:checked|selected)$/i,
...
a.checked=0<=h.inArray(h(a).val(),c):b}})});var qb=/^(?:input|select|textarea)$/i,Ma=/^key/,Qb=/^(?:mouse|contextmenu)|click/,Hb=/^(?:focusinfocus|focusoutblur)$/,Ib=/^([^.]*)(?:\.(.+)|)$/;h.event={global:{},add:function(a,c,d,e,f){var g,p,j,k,q,u,l,n,E;if(j=h._data(a)){d.handler&&(k=d,d=k.handler,f=k.selector);d.guid||(d.guid=h.guid++);(p=j.events)||(p=j.events={});(q=j.handle)||(q=j.handle=function(a){return typeof h===U||a&&h.event.triggered===a.type?b:h.event.dispatch.apply(q.elem,arguments)},
q.elem=a);c=(c||"").match(ya)||[""];for(j=c.length;j--;)g=Ib.exec(c[j])||[],n=u=g[1],E=(g[2]||"").split(".").sort(),g=h.event.special[n]||{},n=(f?g.delegateType:g.bindType)||n,g=h.event.special[n]||{},u=h.extend({type:n,origType:u,data:e,handler:d,guid:d.guid,selector:f,needsContext:f&&h.expr.match.needsContext.test(f),namespace:E.join(".")},k),(l=p[n])||(l=p[n]=[],l.delegateCount=0,g.setup&&!1!==g.setup.call(a,e,E,q)||(a.addEventListener?a.addEventListener(n,q,!1):a.attachEvent&&a.attachEvent("on"+
n,q))),g.add&&(g.add.call(a,u),u.handler.guid||(u.handler.guid=d.guid)),f?l.splice(l.delegateCount++,0,u):l.push(u),h.event.global[n]=!0;a=null}},remove:function(a,b,c,d,e){var f,g,p,j,k,q,u,l,n,E,y,ha=h.hasData(a)&&h._data(a);if(ha&&(q=ha.events)){b=(b||"").match(ya)||[""];for(k=b.length;k--;)if(p=Ib.exec(b[k])||[],n=y=p[1],E=(p[2]||"").split(".").sort(),n){u=h.event.special[n]||{};n=(d?u.delegateType:u.bindType)||n;l=q[n]||[];p=p[2]&&RegExp("(^|\\.)"+E.join("\\.(?:.*\\.|)")+"(\\.|$)");for(j=f=l.length;f--;)g=
l[f],!e&&y!==g.origType||c&&c.guid!==g.guid||p&&!p.test(g.namespace)||d&&d!==g.selector&&("**"!==d||!g.selector)||(l.splice(f,1),g.selector&&l.delegateCount--,u.remove&&u.remove.call(a,g));j&&!l.length&&(u.teardown&&!1!==u.teardown.call(a,E,ha.handle)||h.removeEvent(a,n,ha.handle),delete q[n])}else for(n in q)h.event.remove(a,n+b[k],c,d,!0);h.isEmptyObject(q)&&(delete ha.handle,h._removeData(a,"events"))}},trigger:function(c,d,e,f){var g,p,j,k,q,u,l=[e||D],n=M.call(c,"type")?c.type:c;u=M.call(c,"namespace")?
...
hb=function(){var a,b=[];return a=function(c,d){return b.push(c+=" ")>W.cacheLength&&delete a[b.shift()],a[c]=d}},va=function(a){return a[ia]=!0,a},xa=function(a){var b=wa.createElement("div");try{return a(b)}catch(c){return!1}finally{}},V=function(a,b,c,d){var e,h,f,g,p;if((b?b.ownerDocument||b:ib)!==wa&&sb(b),b=b||wa,c=c||[],!a||"string"!=typeof a)return c;if(1!==(g=b.nodeType)&&9!==g)return[];if(!Ja&&!d){if(e=Wc.exec(a))if(f=e[1])if(9===g){if(h=b.getElementById(f),!h||!h.parentNode)return c;if(h.id===
f)return c.push(h),c}else{if(b.ownerDocument&&(h=b.ownerDocument.getElementById(f))&&Jb(b,h)&&h.id===f)return c.push(h),c}else{if(e[2])return tb.apply(c,ub.call(b.getElementsByTagName(a),0)),c;if((f=e[3])&&la.getByClassName&&b.getElementsByClassName)return tb.apply(c,ub.call(b.getElementsByClassName(f),0)),c}if(la.qsa&&!Na.test(a)){if(e=!0,h=ia,f=b,p=9===g&&a,1===g&&"object"!==b.nodeName.toLowerCase()){g=Sa(a);(e=b.getAttribute("id"))?h=e.replace(Xc,"\\$&"):b.setAttribute("id",h);h="[id='"+h+"'] ";
...
b.nodeType||e)if(j=b[ia]||(b[ia]={}),(p=j[d])&&p[0]===k){if(!0===(g=p[1])||g===Tb)return!0===g}else if(p=j[d]=[k],p[1]=a(b,c,f)||Tb,!0===p[1])return!0}},Ub=function(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]},Kb=function(a,b,c,d,e){for(var h,f=[],g=0,p=a.length,j=null!=b;p>g;g++)(h=a[g])&&(!c||c(h,d,e))&&(f.push(h),j&&b.push(g));return f},Za=function(a,b,c,d,e,h){return d&&!d[ia]&&(d=Za(d)),e&&!e[ia]&&(e=Za(e,h)),va(function(h,f,g,p){var j,
k,q=[],u=[],n=f.length,l;if(!(l=h)){l=b||"*";for(var E=g.nodeType?[g]:g,y=[],ha=0,m=E.length;m>ha;ha++)V(l,E[ha],y);l=y}l=!a||!h&&b?l:Kb(l,q,a,g,p);E=c?e||(h?a:n||d)?[]:f:l;if(c&&c(l,E,g,p),d){j=Kb(E,u);d(j,[],g,p);for(g=j.length;g--;)(k=j[g])&&(E[u[g]]=!(l[u[g]]=k))}if(h){if(e||a){if(e){j=[];for(g=E.length;g--;)(k=E[g])&&j.push(l[g]=k);e(null,E=[],j,p)}for(g=E.length;g--;)(k=E[g])&&-1<(j=e?ec.call(h,k):q[g])&&(h[j]=!(f[j]=k))}}else E=Kb(E===f?E.splice(n,E.length):E),e?e(null,f,E,p):tb.apply(f,E)})},
...
e>d&&fc(a=a.slice(d)),e>d&&vb(a))}j.push(c)}return Ub(j)},vc=function(){},zb,Tb,W,Wb,wc,dc,Ab,Vb,sb,wa,Ea,Ja,Na,Bb,Xb,Jb,gc,ia="sizzle"+-new Date,ib=rb.document,la={},Oa=0,$c=0,xc=hb(),uc=hb(),yc=hb(),tc=-2147483648,Yb=[],ad=Yb.pop,tb=Yb.push,ub=Yb.slice,ec=Yb.indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(this[b]===a)return b;return-1},zc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Ac="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+
...
a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};sb=V.setDocument=function(a){var b=a?a.ownerDocument||a:ib;if(b!==wa&&9===b.nodeType&&b.documentElement){wa=b;Ea=b.documentElement;Ja=wc(b);la.tagNameNoComments=xa(function(a){return a.appendChild(b.createComment("")),!a.getElementsByTagName("*").length});la.attributes=xa(function(a){a.innerHTML="<select></select>";a=typeof a.lastChild.getAttribute("multiple");return"boolean"!==a&&"string"!==a});la.getByClassName=xa(function(a){return a.innerHTML=
"<div class='hidden e'></div><div class='hidden'></div>",a.getElementsByClassName&&a.getElementsByClassName("e").length?(a.lastChild.className="e",2===a.getElementsByClassName("e").length):!1});la.getByName=xa(function(a){a.id=ia+0;a.innerHTML="<a name='"+ia+"'></a><div name='"+ia+"'></div>";Ea.insertBefore(a,Ea.firstChild);var c=b.getElementsByName&&b.getElementsByName(ia).length===2+b.getElementsByName(ia+0).length;return la.getIdNotName=!b.getElementById(ia),Ea.removeChild(a),c});W.attrHandle=
...
function(a,b){var c,d=[],e=0,h=b.getElementsByTagName(a);if("*"===a){for(;c=h[e++];)1===c.nodeType&&d.push(c);return d}return h};W.find.NAME=la.getByName&&function(a,b){return"undefined"!==typeof b.getElementsByName?b.getElementsByName(name):void 0};W.find.CLASS=la.getByClassName&&function(a,b){return"undefined"===typeof b.getElementsByClassName||Ja?void 0:b.getElementsByClassName(a)};Bb=[];Na=[":focus"];(la.qsa=ic.test(b.querySelectorAll+""))&&(xa(function(a){a.innerHTML="<select><option selected=''></option></select>";
a.querySelectorAll("[selected]").length||Na.push("\\[[\\x20\\t\\r\\n\\f]*(?:checked|disabled|ismap|multiple|readonly|selected|value)");a.querySelectorAll(":checked").length||Na.push(":checked")}),xa(function(a){a.innerHTML="<input type='hidden' i=''/>";a.querySelectorAll("[i^='']").length&&Na.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:\"\"|'')");a.querySelectorAll(":enabled").length||Na.push(":enabled",":disabled");a.querySelectorAll("*,:x");Na.push(",.*:")}));a=la;var c;c=Xb=Ea.matchesSelector||Ea.mozMatchesSelector||
Ea.webkitMatchesSelector||Ea.oMatchesSelector||Ea.msMatchesSelector;c=ic.test(c+"");a=((a.matchesSelector=c)&&xa(function(a){la.disconnectedMatch=Xb.call(a,"div");Xb.call(a,"[s!='']:x");Bb.push("!=",hc)}),Na=RegExp(Na.join("|")),Bb=RegExp(Bb.join("|")),Jb=ic.test(Ea.contains+"")||Ea.compareDocumentPosition?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!(!d||1!==d.nodeType||!(c.contains?c.contains(d):a.compareDocumentPosition&&16&a.compareDocumentPosition(d)))}:
...
checkbox:!0,file:!0,password:!0,image:!0})W.pseudos[zb]=xb(zb);for(zb in{submit:!0,reset:!0})W.pseudos[zb]=Ta(zb);dc=V.compile=function(a,b){var c,d=[],e=[],h=yc[a+" "];if(!h){b||(b=Sa(a));for(c=b.length;c--;)h=fc(b[c]),h[ia]?d.push(h):e.push(h);var f=0,g=0<d.length,p=0<e.length;c=function(a,b,c,h,j){var k,R,q=[],u=0,l="0",n=a&&[],E=null!=j,da=Vb,y=a||p&&W.find.TAG("*",j&&b.parentNode||b),ha=Oa+=null==da?1:Math.random()||0.1;for(E&&(Vb=b!==wa&&b,Tb=f);null!=(j=y[l]);l++){if(p&&j){for(k=0;R=e[k++];)if(R(j,
b,c)){h.push(j);break}E&&(Oa=ha,Tb=++f)}g&&((j=!R&&j)&&u--,a&&n.push(j))}if(u+=l,g&&l!==u){for(k=0;R=d[k++];)R(n,q,b,c);if(a){if(0<u)for(;l--;)n[l]||q[l]||(q[l]=ad.call(h));q=Kb(q)}tb.apply(h,q);E&&!a&&0<q.length&&1<u+d.length&&V.uniqueSort(h)}return E&&(Oa=ha,Vb=da),n};c=g?va(c):c;h=yc(a,c)}return h};W.pseudos.nth=W.pseudos.eq;W.filters=vc.prototype=W.pseudos;W.setFilters=new vc;sb();V.attr=h.attr;h.find=V;h.expr=V.selectors;h.expr[":"]=h.expr.pseudos;h.unique=V.uniqueSort;h.text=V.getText;h.isXMLDoc=
...
this.nextSibling,c=this.parentNode;c&&(h(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,d){a=ba.apply([],a);var e,f,g,p,j=0,k=this.length,q=this,u=k-1,l=a[0],E=h.isFunction(l);if(E||!(1>=k||"string"!=typeof l||h.support.checkClone)&&nd.test(l))return this.each(function(e){var h=q.eq(e);E&&(a[0]=l.call(this,e,c?h.html():b));h.domManip(a,c,d)});if(k&&(p=h.buildFragment(a,this[0].ownerDocument,!1,this),e=p.firstChild,1===p.childNodes.length&&
...
G(d,!j&&n(a,"script")),f},buildFragment:function(a,b,c,d){for(var e,f,g,p,j,k,q,u=a.length,l=w(b),E=[],y=0;u>y;y++)if(f=a[y],f||0===f)if("object"===h.type(f))h.merge(E,f.nodeType?[f]:f);else if(ld.test(f)){p=p||l.appendChild(b.createElement("div"));j=(Ec.exec(f)||["",""])[1].toLowerCase();q=Ha[j]||Ha._default;p.innerHTML=q[1]+f.replace(Dc,"<$1></$2>")+q[2];for(e=q[0];e--;)p=p.lastChild;if(!h.support.leadingWhitespace&&jc.test(f)&&E.push(b.createTextNode(jc.exec(f)[0])),!h.support.tbody)for(e=(f="table"!==
j||Fc.test(f)?"<table>"!==q[1]||Fc.test(f)?0:p:p.firstChild)&&f.childNodes.length;e--;)h.nodeName(k=f.childNodes[e],"tbody")&&!k.childNodes.length&&f.removeChild(k);h.merge(E,p.childNodes);for(p.textContent="";p.firstChild;)p.removeChild(p.firstChild);p=l.lastChild}else E.push(b.createTextNode(f));p&&l.removeChild(p);h.support.appendChecked||h.grep(n(E,"input"),N);for(y=0;f=E[y++];)if((!d||-1===h.inArray(f,d))&&(g=h.contains(f.ownerDocument,f),p=n(l.appendChild(f),"script"),g&&G(p),c))for(e=0;f=p[e++];)Gc.test(f.type||
...
arguments.length?this.on(c,null,a,b):this.trigger(c)}});h.fn.hover=function(a,c){return this.mouseenter(a).mouseleave(c||a)};var jb,$a,mc=h.now(),nc=/\?/,xd=/#.*$/,Kc=/([?&])_=[^&]*/,yd=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,zd=/^(?:GET|HEAD)$/,Ad=/^\/\//,Lc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Mc=h.fn.load,Nc={},bc={},Oc="*/".concat("*");try{$a=oa.href}catch(Gd){$a=D.createElement("a"),$a.href="",$a=$a.href}jb=Lc.exec($a.toLowerCase())||[];h.fn.load=function(a,c,d){if("string"!=typeof a&&Mc)return Mc.apply(this,
...
contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,c){return c?ca(ca(a,h.ajaxSettings),c):ca(h.ajaxSettings,a)},ajaxPrefilter:t(Nc),ajaxTransport:t(bc),ajax:function(a,c){function d(a,c,e,f){var u,P,I,R,t,r=c;if(2!==U){U=2;j&&clearTimeout(j);q=b;p=f||"";x.readyState=0<a?4:0;if(e){R=l;f=x;var z,X,Ca,s,ma=R.contents,
M=R.dataTypes,v=R.responseFields;for(s in v)s in e&&(f[v[s]]=e[s]);for(;"*"===M[0];)M.shift(),X===b&&(X=R.mimeType||f.getResponseHeader("Content-Type"));if(X)for(s in ma)if(ma[s]&&ma[s].test(X)){M.unshift(s);break}if(M[0]in e)Ca=M[0];else{for(s in e){if(!M[0]||R.converters[s+" "+M[0]]){Ca=s;break}z||(z=s)}Ca=Ca||z}R=Ca?(Ca!==M[0]&&M.unshift(Ca),e[Ca]):b}if(200<=a&&300>a||304===a)if(l.ifModified&&(t=x.getResponseHeader("Last-Modified"),t&&(h.lastModified[g]=t),t=x.getResponseHeader("etag"),t&&(h.etag[g]=
...
{state:"parsererror",error:w?A:"No conversion from "+z+" to "+P};break a}}z=P}D={state:"success",data:u}}u=D;r=u.state;P=u.data;I=u.error;u=!I}else I=r,(a||!r)&&(r="error",0>a&&(a=0));x.status=a;x.statusText=(c||r)+"";u?y.resolveWith(n,[P,r,x]):y.rejectWith(n,[x,r,I]);x.statusCode(m);m=b;k&&E.trigger(u?"ajaxSuccess":"ajaxError",[x,l,u?P:I]);ha.fireWith(n,[x,r]);k&&(E.trigger("ajaxComplete",[x,l]),--h.active||h.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var e,f,g,p,j,k,q,u,l=
h.ajaxSetup({},c),n=l.context||l,E=l.context&&(n.nodeType||n.jquery)?h(n):h.event,y=h.Deferred(),ha=h.Callbacks("once memory"),m=l.statusCode||{},P={},I={},U=0,t="canceled",x={readyState:0,getResponseHeader:function(a){var c;if(2===U){if(!u)for(u={};c=yd.exec(p);)u[c[1].toLowerCase()]=c[2];c=u[a.toLowerCase()]}return null==c?null:c},getAllResponseHeaders:function(){return 2===U?p:null},setRequestHeader:function(a,c){var b=a.toLowerCase();return U||(a=I[b]=I[b]||a,P[a]=c),this},overrideMimeType:function(a){return U||
(l.mimeType=a),this},statusCode:function(a){var c;if(a)if(2>U)for(c in a)m[c]=[m[c],a[c]];else x.always(a[x.status]);return this},abort:function(a){a=a||t;return q&&q.abort(a),d(0,a),this}};if(y.promise(x).complete=ha.add,x.success=x.done,x.error=x.fail,l.url=((a||l.url||$a)+"").replace(xd,"").replace(Ad,jb[1]+"//"),l.type=c.method||c.type||l.method||l.type,l.dataTypes=h.trim(l.dataType||"*").toLowerCase().match(ya)||[""],null==l.crossDomain&&(e=Lc.exec(l.url.toLowerCase()),l.crossDomain=!(!e||e[1]===
...
2===U))return x.abort();t="abort";for(f in{success:1,error:1,complete:1})x[f](l[f]);if(q=Y(bc,l,c,x)){x.readyState=1;k&&E.trigger("ajaxSend",[x,l]);l.async&&0<l.timeout&&(j=setTimeout(function(){x.abort("timeout")},l.timeout));try{U=1,q.send(P,d)}catch(r){if(!(2>U))throw r;d(-1,r)}}else d(-1,"No Transport");return x},getScript:function(a,c){return h.get(a,b,c,"script")},getJSON:function(a,c,b){return h.get(a,c,b,"json")}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
"string"==typeof j.responseText&&(l.text=j.responseText);try{q=j.statusText}catch(u){q=""}p||!c.isLocal||c.crossDomain?1223===p&&(p=204):p=l.text?200:404}}catch(n){e||f(-1,n)}l&&f(p,q,l,k)};c.async?4===j.readyState?setTimeout(d):(g=++Bd,pc&&(Cb||(Cb={},h(a).unload(pc)),Cb[g]=d),j.onreadystatechange=d):d()},abort:function(){d&&d(b,!0)}}}});var kb,Zb,Cd=/^(?:toggle|show|hide)$/,Dd=RegExp("^(?:([+-])=|)("+Aa+")([a-z%]*)$","i"),Ed=/queueHooks$/,Nb=[function(a,c,b){var d,e,f,g,p,j,k=this,q=a.style,l={},
...
u[e],g=k.createTween(d,n?f[d]:0),l[d]=f[d]||h.style(a,d),d in f||(f[d]=g.start,n&&(g.end=g.start,g.start="width"===d||"height"===d?1:0))}}],Eb={"*":[function(a,c){var b,d,e=this.createTween(a,c),f=Dd.exec(c),g=e.cur(),p=+g||0,j=1,k=20;if(f){if(b=+f[2],d=f[3]||(h.cssNumber[a]?"":"px"),"px"!==d&&p){p=h.css(e.elem,a,!0)||b||1;do j=j||".5",p/=j,h.style(e.elem,a,p+d);while(j!==(j=e.cur()/g)&&1!==j&&--k)}e.unit=d;e.start=p;e.end=f[1]?p+(f[1]+1)*b:b}return e}]};h.Animation=h.extend(F,{tweener:function(a,
c){h.isFunction(a)?(c=a,a=["*"]):a=a.split(" ");for(var b,d=0,e=a.length;e>d;d++)b=a[d],Eb[b]=Eb[b]||[],Eb[b].unshift(c)},prefilter:function(a,c){c?Nb.unshift(a):Nb.push(a)}});h.Tween=L;L.prototype={constructor:L,init:function(a,c,b,d,e,f){this.elem=a;this.prop=b;this.easing=e||"swing";this.options=c;this.start=this.now=this.cur();this.end=d;this.unit=f||(h.cssNumber[b]?"":"px")},cur:function(){var a=L.propHooks[this.prop];return a&&a.get?a.get(this):L.propHooks._default.get(this)},run:function(a){var c,
b=L.propHooks[this.prop];return this.pos=c=this.options.duration?h.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):a,this.now=(this.end-this.start)*c+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),b&&b.set?b.set(this):L.propHooks._default.set(this),this}};L.prototype.init.prototype=L.prototype;L.propHooks={_default:{get:function(a){var c;return null==a.elem[a.prop]||a.elem.style&&null!=a.elem.style[a.prop]?(c=h.css(a.elem,a.prop,""),c&&"auto"!==
c?c:0):a.elem[a.prop]},set:function(a){h.fx.step[a.prop]?h.fx.step[a.prop](a):a.elem.style&&(null!=a.elem.style[h.cssProps[a.prop]]||h.cssHooks[a.prop])?h.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};L.propHooks.scrollTop=L.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};h.each(["toggle","show","hide"],function(a,c){var b=h.fn[c];h.fn[c]=function(a,d,e){return null==a||"boolean"==typeof a?b.apply(this,arguments):this.animate(q(c,!0),
a,d,e)}});h.fn.extend({fadeTo:function(a,c,b,d){return this.filter(B).css("opacity",0).show().end().animate({opacity:c},a,b,d)},animate:function(a,c,b,d){var e=h.isEmptyObject(a),f=h.speed(c,b,d),g=function(){var c=F(this,h.extend({},a),f);g.finish=function(){c.stop(!0)};(e||h._data(this,"finish"))&&c.stop(!0)};return g.finish=g,e||!1===f.queue?this.each(g):this.queue(f.queue,g)},stop:function(a,c,d){var e=function(a){var c=a.stop;delete a.stop;c(d)};return"string"!=typeof a&&(d=c,c=a,a=b),c&&!1!==
...
h.fn.offset=function(a){if(arguments.length)return a===b?this:this.each(function(c){h.offset.setOffset(this,a,c)});var c,d,e={top:0,left:0},f=this[0],g=f&&f.ownerDocument;if(g)return c=g.documentElement,h.contains(c,f)?(typeof f.getBoundingClientRect!==U&&(e=f.getBoundingClientRect()),d=I(g),{top:e.top+(d.pageYOffset||c.scrollTop)-(c.clientTop||0),left:e.left+(d.pageXOffset||c.scrollLeft)-(c.clientLeft||0)}):e};h.offset={setOffset:function(a,c,b){var d=h.css(a,"position");"static"===d&&(a.style.position=
...
g){function v(){return c||!0!==m.options.disabled&&!a(this).hasClass("ui-state-disabled")?("string"==typeof g?m[g]:g).apply(m,arguments):b}"string"!=typeof g&&(v.guid=g.guid=g.guid||v.guid||a.guid++);var r=e.match(/^(\w+)\s*(.*)$/),G=r[1]+m.eventNamespace;(r=r[2])?j.delegate(r,G,v):d.bind(G,v)})},_off:function(a,c){c=(c||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(c).undelegate(c)},_delay:function(a,c){var b=this;return setTimeout(function(){return("string"==typeof a?
...
isWindow:b,offset:c.offset()||{left:0,top:0},scrollLeft:c.scrollLeft(),scrollTop:c.scrollTop(),width:b?c.width():c.outerWidth(),height:b?c.height():c.outerHeight()}}};a.fn.position=function(c){if(!c||!c.of)return v.apply(this,arguments);c=a.extend({},c);var b,n,l,z,r,w,X=a(c.of),N=a.position.getWithinInfo(c.within),t=a.position.getScrollInfo(N),A=(c.collision||"flip").split(" "),G={},S=X,Z=S[0];return w=9===Z.nodeType?{width:S.width(),height:S.height(),offset:{top:0,left:0}}:a.isWindow(Z)?{width:S.width(),
...
top:d.top,left:d.left})})},drag:function(b,d){var c,e,f,k,g,j,m,s,w,v,r=a(this).data("ui-draggable"),G=r.options,A=G.snapTolerance,n=d.offset.left,N=n+r.helperProportions.width,x=d.offset.top,B=x+r.helperProportions.height;for(w=r.snapElements.length-1;0<=w;w--)g=r.snapElements[w].left,j=g+r.snapElements[w].width,m=r.snapElements[w].top,s=m+r.snapElements[w].height,g-A>N||n>j+A||m-A>B||x>s+A||!a.contains(r.snapElements[w].item.ownerDocument,r.snapElements[w].item)?(r.snapElements[w].snapping&&r.options.snap.release&&
r.options.snap.release.call(r.element,b,a.extend(r._uiHash(),{snapItem:r.snapElements[w].item})),r.snapElements[w].snapping=!1):("inner"!==G.snapMode&&(c=A>=Math.abs(m-B),e=A>=Math.abs(s-x),f=A>=Math.abs(g-N),k=A>=Math.abs(j-n),c&&(d.position.top=r._convertPositionTo("relative",{top:m-r.helperProportions.height,left:0}).top-r.margins.top),e&&(d.position.top=r._convertPositionTo("relative",{top:s,left:0}).top-r.margins.top),f&&(d.position.left=r._convertPositionTo("relative",{top:0,left:g-r.helperProportions.width}).left-
r.margins.left),k&&(d.position.left=r._convertPositionTo("relative",{top:0,left:j}).left-r.margins.left)),v=c||e||f||k,"outer"!==G.snapMode&&(c=A>=Math.abs(m-x),e=A>=Math.abs(s-B),f=A>=Math.abs(g-n),k=A>=Math.abs(j-N),c&&(d.position.top=r._convertPositionTo("relative",{top:m,left:0}).top-r.margins.top),e&&(d.position.top=r._convertPositionTo("relative",{top:s-r.helperProportions.height,left:0}).top-r.margins.top),f&&(d.position.left=r._convertPositionTo("relative",{top:0,left:g}).left-r.margins.left),
...
b=c.options,d=c.size,k=c.originalSize,g=c.originalPosition,j=c.axis,m="number"==typeof b.grid?[b.grid,b.grid]:b.grid,s=m[0]||1,w=m[1]||1,v=Math.round((d.width-k.width)/s)*s,d=Math.round((d.height-k.height)/w)*w,r=k.width+v,k=k.height+d,G=b.maxWidth&&r>b.maxWidth,A=b.maxHeight&&k>b.maxHeight,n=b.minWidth&&b.minWidth>r,N=b.minHeight&&b.minHeight>k;b.grid=m;n&&(r+=s);N&&(k+=w);G&&(r-=s);A&&(k-=w);/^(se|s|e)$/.test(j)?(c.size.width=r,c.size.height=k):/^(ne)$/.test(j)?(c.size.width=r,c.size.height=k,c.position.top=
...
d,e,f){function g(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function j(a){if(l){if(w&&9>document.documentMode&&!a.button)return k();var b=a.originalEvent.touches,e=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-n.left,I)),e=Math.max(0,Math.min(e-n.top,m));P&&g(a);d.apply(c,[b,e,a])}}function k(){l&&(b(q).unbind(r),b(q.body).removeClass("sp-dragging"),f.apply(c,arguments));l=!1}d=d||function(){};e=e||function(){};f=f||function(){};
var q=c.ownerDocument||document,l=!1,n={},m=0,I=0,P="ontouchstart"in a,r={};r.selectstart=g;r.dragstart=g;r[P?"touchmove":"mousemove"]=j;r[P?"touchend":"mouseup"]=k;b(c).bind(P?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!l&&!1!==e.apply(c,arguments))l=!0,m=b(c).height(),I=b(c).width(),n=b(c).offset(),b(q).bind(r),b(q.body).addClass("sp-dragging"),P||j(a),g(a)})}var m={beforeShow:f,move:f,change:f,show:f,hide:f,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
...
!J.showInput);u.toggleClass("sp-alpha-enabled",J.showAlpha);u.toggleClass("sp-buttons-disabled",!J.showButtons||F);u.toggleClass("sp-palette-disabled",!J.showPalette);u.toggleClass("sp-palette-only",J.showPaletteOnly);u.toggleClass("sp-initial-disabled",!J.showInitial);u.addClass(J.className);O()},n=function(c){if(Y&&(c=tinycolor(c).toRgbString(),-1===b.inArray(c,Fa)&&Fa.push(c),ca&&a.localStorage))try{a.localStorage[ca]=Fa.join(";")}catch(d){}},y=function(){var a=[],b=Fa,c={},d;if(J.showPalette){for(var e=
0;e<gb.length;e++)for(var h=0;h<gb[e].length;h++)d=tinycolor(gb[e][h]).toRgbString(),c[d]=!0;for(e=0;e<b.length;e++)d=tinycolor(b[e]).toRgbString(),c.hasOwnProperty(d)||(a.push(b[e]),c[d]=!0)}return a.reverse().slice(0,J.maxSelectionSize)},I=function(){var a=x(),d=b.map(gb,function(b,d){return c(b,a,"sp-palette-row sp-palette-row-"+d)});Fa&&d.push(c(y(),a,"sp-palette-row sp-palette-row-selection"));Qb.html(d.join(""))},r=function(){if(J.showInitial){var a=Ta,b=x();Hb.html(c([a,b],b,"sp-palette-row-initial"))}},
t=function(){(0===ea||0===aa||0===ja)&&O();u.addClass(ta)},U=function(){u.removeClass(ta)},P=function(){var a=tinycolor(Ma.val());a.ok?h(a):Ma.addClass("sp-validation-error")},X=function(){Ba?D():z()},z=function(){if(Ba)O();else if(!1!==H.beforeShow(x())){for(var c=0;c<s.length;c++)s[c]&&s[c].hide();Ba=!0;b(ua).bind("click.spectrum",D);b(a).bind("resize.spectrum",S);xa.addClass("sp-active");u.show();J.showPalette&&I();O();N();Ta=x();r();H.show(Ta)}},D=function(c){if((!c||!("click"==c.type&&2==c.button))&&
Ba&&!F)Ba=!1,b(ua).unbind("click.spectrum",D),b(a).unbind("resize.spectrum",S),xa.removeClass("sp-active"),u.hide(),tinycolor.equals(x(),Ta)||(vb&&"cancel"!==c?B(!0):h(Ta,!0)),H.hide(x())},h=function(a,b){if(!tinycolor.equals(a,x())){var c=tinycolor(a),d=c.toHsv();ga=d.h;La=d.s;na=d.v;K=d.a;N();b||(Sa=Ka||c.format)}},x=function(){return tinycolor.fromRatio({h:ga,s:La,v:na,a:Math.round(100*K)/100})},A=function(){N();H.move(x())},N=function(){Ma.removeClass("sp-validation-error");T();var a=tinycolor({h:ga,
...
n(xb)):N();F&&z();t=w?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Qb.delegate(".sp-thumb-el",t,L);Hb.delegate(".sp-thumb-el:nth-child(1)",t,{ignore:!0},L);var Za={show:z,hide:D,toggle:X,reflow:O,option:function(a,c){if(a===d)return b.extend({},J);if(c===d)return J[a];J[a]=c;l()},enable:function(){p=!1;sa.attr("disabled",!1);V.removeClass("sp-disabled")},disable:q,set:function(a){h(a);B()},get:x,destroy:function(){sa.show();V.unbind("click.spectrum touchstart.spectrum");u.remove();xa.remove();
...
e,f){if(b.call(c,a,e,f))return d=a,!0});return d};l.filter=l.select=function(a,b,c){var d=[];if(null==a)return d;if(G&&a.filter===G)return a.filter(b,c);z(a,function(a,e,f){b.call(c,a,e,f)&&(d[d.length]=a)});return d};l.reject=function(a,b,c){var d=[];if(null==a)return d;z(a,function(a,e,f){b.call(c,a,e,f)||(d[d.length]=a)});return d};l.every=l.all=function(a,b,d){var e=!0;if(null==a)return e;if(A&&a.every===A)return a.every(b,d);z(a,function(a,f,g){if(!(e=e&&b.call(d,a,f,g)))return c});return!!e};
var O=l.some=l.any=function(a,b,d){b||(b=l.identity);var e=!1;if(null==a)return e;if(n&&a.some===n)return a.some(b,d);z(a,function(a,f,g){if(e||(e=b.call(d,a,f,g)))return c});return!!e};l.include=l.contains=function(a,b){return null==a?!1:N&&a.indexOf===N?-1!=a.indexOf(b):O(a,function(a){return a===b})};l.invoke=function(a,b){var c=k.call(arguments,2);return l.map(a,function(a){return(l.isFunction(b)?b||a:a[b]).apply(a,c)})};l.pluck=function(a,b){return l.map(a,function(a){return a[b]})};l.max=function(a,
...
(function(){function a(a,b){return"!"!==a[0][0]?'<a href="'+f(b.href)+'"'+(b.title?' title="'+f(b.title)+'"':"")+">"+n.lexer(a[1])+"</a>":'<img src="'+f(b.href)+'" alt="'+f(a[1])+'"'+(b.title?' title="'+f(b.title)+'"':"")+">"}function b(){return x=N.pop()}function d(){switch(x.type){case "space":return"";case "hr":return"<hr>\n";case "heading":return"<h"+x.depth+">"+n.lexer(x.text)+"</h"+x.depth+">\n";case "code":return B.highlight&&(x.code=B.highlight(x.text,x.lang),null!=x.code&&x.code!==x.text&&
...
"";"list_item_end"!==b().type;)a+=d();return"<li>"+a+"</li>\n";case "html":return B.sanitize?n.lexer(x.text):!x.pre&&!B.pedantic?n.lexer(x.text):x.text;case "paragraph":return"<p>"+n.lexer(x.text)+"</p>\n";case "text":return"<p>"+c()+"</p>\n"}}function c(){for(var a=x.text,c;(c=N[N.length-1])&&"text"===c.type;)a+="\n"+b().text;return n.lexer(a)}function e(a){N=a.reverse();for(a="";b();)a+=d();x=N=null;return a}function f(a,b){return a.replace(!b?/&(?!#?\w+;)/g:/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],f=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],g=Array(64),k,G,A,n,N,x,B,C,l,z,O,J;a[b>>5]|=128<<24-b%
32;a[(b+64>>9<<4)+15]=b;for(l=0;l<a.length;l+=16){k=f[0];G=f[1];A=f[2];n=f[3];N=f[4];x=f[5];B=f[6];C=f[7];for(z=0;64>z;z++)g[z]=16>z?a[z+l]:d(d(d(c(g[z-2],17)^c(g[z-2],19)^g[z-2]>>>10,g[z-7]),c(g[z-15],7)^c(g[z-15],18)^g[z-15]>>>3),g[z-16]),O=d(d(d(d(C,c(N,6)^c(N,11)^c(N,25)),N&x^~N&B),e[z]),g[z]),J=d(c(k,2)^c(k,13)^c(k,22),k&G^k&A^G&A),C=B,B=x,x=N,N=d(n,O),n=A,A=G,G=k,k=d(O,J);f[0]=d(k,f[0]);f[1]=d(G,f[1]);f[2]=d(A,f[2]);f[3]=d(n,f[3]);f[4]=d(N,f[4]);f[5]=d(x,f[5]);f[6]=d(B,f[6]);f[7]=d(C,f[7])}return f},
...
for(var r=Array(16),w=Array(16),G=0;16>G;G++)r[G]=v[G]^909522486,w[G]=v[G]^1549556828;d=e(r.concat(f(d)),512+d.length*b);d=e(w.concat(d),768);return k(d)},sha256config:function(a){b=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=g(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);function Space(a){this.keys=[];this.values={};this.events={};this._load(a);return this}Space.pathBranch=function(a){a=a.split(/ /g);if(2>a.length)return"";a.pop();return a.join(" ")};
...
(function(a){function b(a){a=String(a);return a.charAt(0).toUpperCase()+a.slice(1)}function d(a){a=j(a);return/^(?:webOS|i(?:OS|P))/.test(a)?a:b(a)}function c(a,b){for(var c in a)f(a,c)&&b(a[c],c,a)}function e(a){return null==a?b(a):G.call(a).slice(8,-1)}function f(){f=function(a,b){var c=null!=a&&(a.constructor||Object).prototype;return!!c&&b in Object(a)&&!(b in c&&a[b]===c[b])};"Function"==e(B)?f=function(a,b){return null!=a&&B.call(a,b)}:{}.__proto__==Object.prototype&&(f=function(a,b){var c=
...
e+"(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)","i").exec(b))){if((a=String(c.label||a).split("/"))[1]&&!/[\d.]+/.test(a[0]))a[0]+=" "+a[1];c=c.label||c;a=d(a[0].replace(RegExp(e,"i"),c).replace(RegExp("; *(?:"+c+"[_-])?","i")," ").replace(RegExp("("+c+")(\\w)","i"),"$1 $2"))}return a})}b||(b=J);var t,w=b,B=[],S=null,Z=b==J,F=Z&&l&&"function"==typeof l.version&&l.version(),L=g([{label:"WebKit",pattern:"AppleWebKit"},"iCab","Presto","NetFront","Tasman","Trident","KHTML","Gecko"],function(a,c){return a||
...
"$1").replace(/\/(\d)/," $1").replace(/_/g,".").replace(/(?: BePC|[ .]*fc[ \d.]+)$/i,"").replace(/x86\.64/gi,"x86_64").split(" on ")[0])}return a});L&&(L=[L]);E&&!I&&(I=f([E]));if(t=/Google TV/.exec(I))I=t[0];/\bSimulator\b/i.test(b)&&(I=(I?I+" ":"")+"Simulator");if(/^iP/.test(I))q||(q="Safari"),y="iOS"+((t=/ OS ([\d_]+)/i.exec(b))?" "+t[1].replace(/_/g,"."):"");else if("Konqueror"==q&&!/buntu/i.test(y))y="Kubuntu";else if(E&&"Google"!=E&&/Chrome|Vita/.test(q+";"+I))q="Android Browser",y=/Android/.test(y)?
y:"Android";else if(!q||(t=!/\bMinefield\b/i.test(b)&&/Firefox|Safari/.exec(q)))if(q&&(!I&&/[\/,]|^[^(]+?\)/.test(b.slice(b.indexOf(t+"/")+8)))&&(q=null),(t=I||E||y)&&(I||E||/Android|Symbian OS|Tablet OS|webOS/.test(y)))q=/[a-z]+(?: Hat)?/i.exec(/Android/.test(y)?y:t)+" Browser";F||(F=["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",k(q),"(?:Firefox|Minefield|NetFront)"],F=g(F,function(a,c){return a||(RegExp(c+"(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)","i").exec(b)||
0)[1]||null}));if("iCab"==L&&3<parseFloat(F))L=["WebKit"];else if(t=/Opera/.test(q)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(b)&&"WebKit"||!L&&/\bMSIE\b/i.test(b)&&(/^Mac/.test(y)?"Tasman":"Trident"))L=[t];if(Z){var U=a,D=null!=U?typeof U.global:"number";if(!/^(?:boolean|number|string|undefined)$/.test(D)&&("object"==D?U.global:1))if(A&&(t=A.lang.System,w=t.getProperty("os.arch"),y=y||t.getProperty("os.name")+" "+t.getProperty("os.version")),"object"==typeof exports&&exports)if(O==s&&"object"==
...
"."+t.minor+"."+t.patch;else if("number"==typeof x.documentMode&&(t=/\bTrident\/(\d+)/i.exec(b))){F=[F,x.documentMode];if((t=+t[1]+4)!=F[1])B.push("IE "+F[1]+" mode"),L[1]="",F[1]=t;F="IE"==q?String(F[1].toFixed(1)):F[0]}y=y&&d(y)}if(F&&(t=/(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(F)||/(?:alpha|beta)(?: ?\d)?/i.exec(b+";"+(Z&&C.appMinorVersion))||/\bMinefield\b/i.test(b)&&"a"))S=/b/i.test(t)?"beta":"alpha",F=F.replace(RegExp(t+"\\+?$"),"")+("beta"==S?N:n)+(/\d+\+?/.exec(t)||"");if("Fennec"==
q)q="Firefox Mobile";else if("Maxthon"==q&&F)F=F.replace(/\.[\d.]+/,".x");else if("Silk"==q)/Mobi/i.test(b)||(y="Android",B.unshift("desktop mode")),/Accelerated *= *true/i.test(b)&&B.unshift("accelerated");else if("IE"==q&&(t=(/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(b)||0)[1]))q+=" Mobile",y="Windows Phone OS "+t+".x",B.unshift("desktop mode");else if(("IE"==q||q&&!I&&!/Browser|Mobi/.test(q))&&("Windows CE"==y||/Mobi/i.test(b)))q+=" Mobile";else if("IE"==q&&Z&&"object"==typeof external&&!external)B.unshift("platform preview");
else if(/BlackBerry/.test(I)&&(t=(RegExp(I.replace(/ +/g," *")+"/([.\\d]+)","i").exec(b)||0)[1]||F))y="Device Software "+t,F=null;else if(this!=c&&(Z&&l||/Opera/.test(q)&&/\b(?:MSIE|Firefox)\b/i.test(b)||"Firefox"==q&&/OS X (?:\d+\.){2,}/.test(y)||"IE"==q&&(y&&!/^Win/.test(y)&&5.5<F||/Windows XP/.test(y)&&8<F||8==F&&!/Trident/.test(b)))&&!r.test(t=m.call(c,b.replace(r,"")+";"))&&t.name)t="ing as "+t.name+((t=t.version)?" "+t:""),r.test(q)?(/IE/.test(t)&&"Mac OS"==y&&(y=null),t="identify"+t):(t="mask"+
t,q=z?d(z.replace(/([a-z])([A-Z])/g,"$1 $2")):"Opera",/IE/.test(t)&&(y=null),Z||(F=null)),L=["Presto"],B.push(t);if(t=(/\bAppleWebKit\/([\d.]+\+?)/i.exec(b)||0)[1]){t=[parseFloat(t.replace(/\.(\d)$/,".0$1")),t];if("Safari"==q&&"+"==t[1].slice(-1))q="WebKit Nightly",S="alpha",F=t[1].slice(0,-1);else if(F==t[1]||F==(/\bSafari\/([\d.]+\+?)/i.exec(b)||0)[1])F=null;t=[t[0],(/\bChrome\/([\d.]+)/i.exec(b)||0)[1]];!Z||/internal|\n/i.test(G.toString())&&!t[1]?(L[1]="like Safari",t=(t=t[0],400>t?1:500>t?2:
...
var cssToObject=function(a,b){function d(a){var b=a.match(/\n/g);b&&(z+=b.length);b=a.lastIndexOf("\n");O=~b?a.length-b:O+a.length}function c(){var a={line:z,column:O};return!b.position?e:function(b){b.position={start:a,end:{line:z,column:O}};j(/^\s*/);return b}}function e(a){j(/^\s*/);return a}function f(b){b=Error(b+" near line "+z+":"+O);b.line=z;b.column=O;b.source=a;throw b;}function k(){return j(/^{\s*/)}function g(){var b,c=[];j(/^\s*/);for(m(c);"}"!=a[0]&&(b=A()||(N()||n()||C("import")||C("charset")||
C("namespace")||B()||x())||l());)c.push(b),m(c);return c}function j(b){if(b=b.exec(a)){var c=b[0];d(c);a=a.slice(c.length);return b}}function m(a){var b;for(a=a||[];b=s();)a.push(b);return a}function s(){var b=c();if(!("/"!=a[0]||"*"!=a[1])){for(var e=2;null!=a[e]&&("*"!=a[e]||"/"!=a[e+1]);)++e;var e=e+2,f=a.slice(2,e-2);O+=2;d(f);a=a.slice(e);O+=2;return b({type:"comment",comment:f})}}function w(){var a=j(/^([^{]+)/);if(a)return a[0].trim().split(/\s*,\s*/)}function v(){var a=c(),b=j(/^(\*?[-\w]+)\s*/);
if(b){b=b[0];if(!j(/^:\s*/))return f("property missing ':'");var d=j(/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^\)]*?\)|[^};])+)/);if(!d)return f("property missing value");a=a({type:"declaration",property:b,value:d[0].trim()});j(/^[;\s]*/);return a}}function r(){var a=[];if(!k())return f("missing '{'");m(a);for(var b;b=v();)a.push(b),m(a);return!j(/^}/)?f("missing '}'"):a}function G(){for(var a,b=[],d=c();a=j(/^(from|to|\d+%|\.\d+%|\d+\.\d+%)\s*/);)b.push(a[1]),j(/^,\s*/);if(b.length)return d({type:"keyframe",
values:b,declarations:r()})}function A(){var a=c(),b=j(/^@([-\w]+)?keyframes */);if(b){var d=b[1],b=j(/^([-\w]+)\s*/);if(!b)return f("@keyframes missing name");b=b[1];if(!k())return f("@keyframes missing '{'");for(var e,g=m();e=G();)g.push(e),g=g.concat(m());return!j(/^}/)?f("@keyframes missing '}'"):a({type:"keyframes",name:b,vendor:d,keyframes:g})}}function n(){var a=c(),b=j(/^@supports *([^{]+)/);if(b){b=b[1].trim();if(!k())return f("@supports missing '{'");var d=m().concat(g());return!j(/^}/)?
f("@supports missing '}'"):a({type:"supports",supports:b,rules:d})}}function N(){var a=c(),b=j(/^@media *([^{]+)/);if(b){b=b[1].trim();if(!k())return f("@media missing '{'");var d=m().concat(g());return!j(/^}/)?f("@media missing '}'"):a({type:"media",media:b,rules:d})}}function x(){var a=c();if(j(/^@page */)){var b=w()||[];if(!k())return f("@page missing '{'");for(var d=m(),e;e=v();)d.push(e),d=d.concat(m());return!j(/^}/)?f("@page missing '}'"):a({type:"page",selectors:b,declarations:d})}}function B(){var a=
c(),b=j(/^@([-\w]+)?document *([^{]+)/);if(b){var d=(b[1]||"").trim(),b=b[2].trim();if(!k())return f("@document missing '{'");var e=m().concat(g());return!j(/^}/)?f("@document missing '}'"):a({type:"document",document:b,vendor:d,rules:e})}}function C(a){var b=c(),d=j(RegExp("^@"+a+" *([^;\\n]+);"));if(d){var e={type:a};e[a]=d[1].trim();return b(e)}}function l(){var a=c(),b=w();if(b)return m(),a({type:"rule",selectors:b,declarations:r()})}b=b||{};var z=1,O=1;return{type:"stylesheet",stylesheet:{rules:g()}}},
...
Blog.install=function(){Project.get("posts")||Explorer.mkdir("private posts")};Blog.permalink=function(a){return!a?"":a.toLowerCase().replace(/[^a-z0-9- _\.]/gi,"").replace(/ /g,"-")};Blog.pressPost=function(a,b){var d=new Space(a),c=(new Page(b)).toHtml(),c=c.replace("Blog Post Title",d.get("title")),c=c.replace("Blog Post Content",d.get("content"));return c=html_beautify(c)};
Blog.publishAll=function(){Explorer.getFolder("posts",function(a){(new Space(a)).each(function(a,d){var c=Blog.permalink(a.replace(/\.space/,"")),e=d.get("template"),e=Project.get("pages "+e);e||(e=Blog.blankTheme);e=Blog.pressPost(d.toString(),e.toString());Explorer.set(c+".html",e,function(){Flasher.success("published "+c)})})})};
...
a;var d=Blog.permalink(a),c=b.get("template"),c=Project.get("pages "+c);c||(c=Blog.blankTheme);b=Blog.pressPost(b.toString(),c.toString());Explorer.set(d+".html",b,function(){window.open(a+".html","published")})};Blog.updatePermalink=function(){var a=Blog.permalink($("#BlogTitle").val());$("#BlogPermalink").text("http://"+document.location.host+"/"+a).attr("value",a)};Blog.on("close",function(){Project.off("change",Blog.refresh)});
Blog.on("open",function(){Blog.blankTheme=new Space($("#BlogTheme").text());Blog.install();Project.on("change",Blog.refresh);Blog.refresh()});var Boston=new Tool("Boston");Boston.set("color","rgba(26, 134, 214, 1)");Boston.set("description","Design pages for your project.");Boston.page=new Page;Boston.edge=new Space;Boston.stage={};Boston.stage.activePage="index";Boston.menu={};Boston.stage.selection={};Boston.blurThis=function(){$(this).blur()};Boston.stopProp=function(a){a.stopPropagation()};
...
Boston.styleEditor.edit=function(a){$(".handle").remove();var b=$('<div id="BostonStyleEditorModal"/>');b.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});b.on("click",function(){G.trigger("click")});$("body").append(b);var d=a.element(),c=$('<div id="BostonStyleEditor"></div>');c.css({left:d.offset().left+2+"px",top:d.offset().top+d.outerHeight()+4+"px"});d=$('<div id="BostonStyleEditorTopBar"></div>');c.append(d);var e=$('<div class="editorOption selectedEditorOption">Block</div>');
...
d.on("tap",function(){Boston.stage.selection.patch("locked true");G.trigger("click");return!1});f.append(d);var g=$('<select id="nudgepadLinkSelect"></select>'),d=$("<option>No link</option>");d.on("click",function(){Boston.stage.selection.patch("href ")});g.append(d);_.each(Project.values.pages.values,function(a,b){var c=$('<option value="'+b+'">'+ToProperCase(b)+"</option>");c.on("click",function(){Boston.stage.selection.patch("tag a\nhref "+$(this).attr("value"))});g.append(c)});d=$("<option>New Page</option>");
d.on("click",function(){var a=prompt("Enter the name of your new page",Boston.menu.nextName(Boston.stage.activePage));if(a){a=Permalink(a);Boston.stage.selection.patch("tag a\nhref "+a);G.trigger("click");var b=Boston.stage.activePage;Boston.menu.duplicate(null,a,!0);Boston.stage.open(b)}});g.append(d);d=$("<option>External Link</option>");d.on("click",function(){var a=prompt("Enter the url to link to","http://");a&&Boston.stage.selection.patch("tag a\nhref "+a)});g.append(d);g.css({display:"none",
...
a;r.on("keyup",Boston.styleEditor.livePreviewStart);c.append(r);e=$('<div id="BostonStyleEditorBottomBar"></div>');r.append(e);var G=$('<div id="BostonStyleEditorSaveButton">Save</div>');G.on("click",function(){Boston.stage.commit();$(".handle").trigger("update");c.remove();b.remove()});r.append(G);$("body").append(c);var A;$(".colorPicker").spectrum({color:k,move:function(a){Boston.stage.selection.cssPreview("background-color "+a.toHexString());k=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+
...
Files.renderExplorer=function(){var a=Files.get("files");Files.get("path")&&(a=a.get(Files.get("path")));var b='<table id="FilesExplorer">',b=b+'<tr class="FilesExplorerHeader"><td>Filename</td><td></td><td></td><td></td><td>Size</td><td>Age</td></tr>',d=Files.get("path")?Files.get("path")+" ":"";a.each(function(a,c){var e="<tr";c.get("timeSinceLastChange")?(e+=' class="FilesExplorerFile" value="'+a+'" path="'+d+a+'">',e=Files.isImage(a)?e+('<td class="FilesExplorerPreview">'+a+"</td>"):e+('<td class="FilesExplorerEdit">'+
a+"</td>"),e=d.match(/^private/)?e+"<td></td>":e+('<td class="FilesHiddenAction FilesExplorerVisit"><a target="published" href="/'+d.replace(/ /g,"/")+a+'">Visit</a></td>'),e+='<td class="FilesHiddenAction FilesExplorerRename">Rename</td><td class="FilesHiddenAction FilesExplorerRemove">Delete</td>',e+="<td>"+c.get("size")+"</td>",e+="<td>"+moment(c.get("mtime")).fromNow()+"</td>"):(e+=' class="FilesExplorerFolder" value="'+a+'" path="'+d+a+'">',e+='<td class="FilesExplorerFolderName">'+a+"</td>",
e+="<td></td>",e+='<td class="FilesHiddenAction FilesExplorerRename">Rename</td>',e+='<td class="FilesHiddenAction FilesExplorerRemoveFolder">Delete</td>',e+="<td></td><td></td>");e+="</tr>";b+=e});var b=b+"</table>",c="<span onclick=\"Files.set('path', '')\">"+document.location.host+"</span>";if(d){var e="";d.split(/ /g).forEach(function(a){c+=" <span onclick=\"Files.set('path', '"+e+a+"')\">"+a+"</span>";e+=a+" "})}$("#FilesExplorerPath").html(c);$("#FilesExplorerHolder").html(b)};
