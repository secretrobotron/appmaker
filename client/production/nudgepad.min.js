...
var d,e=0,f=c.toLowerCase().match(xa)||[];if(h.isFunction(b))for(;d=f[e++];)"+"===d[0]?(d=d.slice(1)||"*",(a[d]=a[d]||[]).unshift(b)):(a[d]=a[d]||[]).push(b)}}function Y(a,b,d,e){function f(j){var k;return g[j]=!0,h.each(a[j]||[],function(a,Q){var h=Q(b,d,e);return"string"!=typeof h||p||g[h]?p?!(k=h):c:(b.dataTypes.unshift(h),f(h),!1)}),k}var g={},p=a===bc;return f(b.dataTypes[0])||!g["*"]&&f("*")}function ca(a,b){var d,e,f=h.ajaxSettings.flatOptions||{};for(e in b)b[e]!==c&&((f[e]?a:d||(d={}))[e]=
b[e]);return d&&h.extend(!0,a,d),a}function S(){try{return new a.XMLHttpRequest}catch(Q){}}function Z(){return setTimeout(function(){kb=c}),kb=h.now()}function E(a,c,b){var d,e,f=0,g=Nb.length,p=h.Deferred().always(function(){delete j.elem}),j=function(){if(e)return!1;for(var c=kb||Z(),c=Math.max(0,k.startTime+k.duration-c),b=1-(c/k.duration||0),d=0,da=k.tweens.length;da>d;d++)k.tweens[d].run(b);return p.notifyWith(a,[k,b,c]),1>b&&da?c:(p.resolveWith(a,[k]),!1)},k=p.promise({elem:a,props:h.extend({},
...
h.isArray(d)&&(l=d[1],d=c[u]=d[0]),u!==q&&(c[q]=d,delete c[u]),n=h.cssHooks[q],n&&"expand"in n)for(u in d=n.expand(d),delete c[q],d)u in c||(c[u]=d[u],b[u]=l);else b[q]=l;for(;g>f;f++)if(d=Nb[f].call(k,a,c,k.opts))return d;var m=k;h.each(c,function(a,Q){for(var c=(Eb[a]||[]).concat(Eb["*"]),b=0,d=c.length;d>b&&!c[b].call(m,a,Q);b++);});return h.isFunction(k.opts.start)&&k.opts.start.call(a,k),h.fx.timer(h.extend(j,{elem:a,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,k.opts.complete).fail(k.opts.fail).always(k.opts.always)}
function K(a,c,b,d,e){return new K.prototype.init(a,c,b,d,e)}function q(a,c){var b,d={height:a},e=0;for(c=c?1:0;4>e;e+=2-c)b=ab[e],d["margin"+b]=d["padding"+b]=a;return c&&(d.opacity=d.width=a),d}function H(a){return h.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var R,y,U=typeof c,D=a.document,na=a.location,Ua=a.jQuery,Va=a.$,oa={},ya=[],ba=ya.concat,pa=ya.push,fa=ya.slice,O=ya.indexOf,la=oa.toString,L=oa.hasOwnProperty,lb="1.9.1".trim,h=function(a,c){return new h.fn.init(a,c,y)},
za=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,xa=/\S+/g,Wa=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,db=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,eb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Fb=/^[\],:{}\s]*$/,Ob=/(?:^|:|,)(?:\s*\[)+/g,Pa=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,mb=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Ia=/^-ms-/,Gb=/-([\da-z])/gi,Pb=function(a,c){return c.toUpperCase()},G=function(a){(D.addEventListener||"load"===a.type||"complete"===D.readyState)&&(Qa(),h.ready())},Qa=function(){D.addEventListener?
(D.removeEventListener("DOMContentLoaded",G,!1),a.removeEventListener("load",G,!1)):(D.detachEvent("onreadystatechange",G),a.detachEvent("onload",G))};h.fn=h.prototype={jquery:"1.9.1",constructor:h,init:function(a,b,d){var e,f;if(!a)return this;if("string"==typeof a){if(e="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:db.exec(a),!e||!e[1]&&b)return!b||b.jquery?(b||d).find(a):this.constructor(b).find(a);if(e[1]){if(b=b instanceof h?b[0]:b,h.merge(this,h.parseHTML(e[1],b&&
...
(0>a?c:0);return this.pushStack(0<=a&&c>a?[this[a]]:[])},map:function(a){return this.pushStack(h.map(this,function(c,b){return a.call(c,b,c)}))},end:function(){return this.prevObject||this.constructor(null)},push:pa,sort:[].sort,splice:[].splice};h.fn.init.prototype=h.fn;h.extend=h.fn.extend=function(){var a,b,d,e,f,g,p=arguments[0]||{},j=1,k=arguments.length,q=!1;"boolean"==typeof p&&(q=p,p=arguments[1]||{},j=2);"object"==typeof p||h.isFunction(p)||(p={});for(k===j&&(p=this,--j);k>j;j++)if(null!=
...
this,d.concat(fa.call(arguments)))},e.guid=a.guid=a.guid||h.guid++,e):c},access:function(a,b,d,e,f,g,p){var j=0,k=a.length,q=null==d;if("object"===h.type(d))for(j in f=!0,d)h.access(a,b,j,d[j],!0,g,p);else if(e!==c&&(f=!0,h.isFunction(e)||(p=!0),q&&(p?(b.call(a,e),b=null):(q=b,b=function(a,c,b){return q.call(h(a),b)})),b))for(;k>j;j++)b(a[j],d,p?e:e.call(a[j],j,b(a[j],d)));return f?a:q?b.call(a):k?b(a[0],d):g},now:function(){return(new Date).getTime()}});h.ready.promise=function(c){if(!R)if(R=h.Deferred(),
"complete"===D.readyState)setTimeout(h.ready);else if(D.addEventListener)D.addEventListener("DOMContentLoaded",G,!1),a.addEventListener("load",G,!1);else{D.attachEvent("onreadystatechange",G);a.attachEvent("onload",G);var b=!1;try{b=null==a.frameElement&&D.documentElement}catch(d){}b&&b.doScroll&&function Qc(){if(!h.isReady){try{b.doScroll("left")}catch(a){return setTimeout(Qc,50)}Qa();h.ready()}}()}return R.promise(c)};h.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(a,c){oa["[object "+c+"]"]=c.toLowerCase()});y=h(D);var Ra={};h.Callbacks=function(a){var b;if("string"==typeof a){if(!(b=Ra[a])){b=a;var d=Ra[b]={};b=(h.each(b.match(xa)||[],function(a,c){d[c]=!0}),d)}}else b=h.extend({},a);a=b;var e,f,g,p,j,k,q=[],u=!a.once&&[],l=function(c){f=a.memory&&c;g=!0;j=k||0;k=0;p=q.length;for(e=!0;q&&p>j;j++)if(!1===q[j].apply(c[0],c[1])&&a.stopOnFalse){f=!1;break}e=!1;q&&(u?u.length&&l(u.shift()):f?q=[]:n.disable())},n={add:function(){if(q){var c=q.length;(function Vc(c){h.each(c,
...
"fx",[])},promise:function(a,b){var d,e=1,f=h.Deferred(),g=this,p=this.length,j=function(){--e||f.resolveWith(g,[g])};"string"!=typeof a&&(b=a,a=c);for(a=a||"fx";p--;)(d=h._data(g[p],a+"queueHooks"))&&d.empty&&(e++,d.empty.add(j));return j(),f.promise(b)}});var ta,ra,p=/[\t\r\n]/g,u=/\r/g,Ba=/^(?:input|select|textarea|button|object)$/i,Ca=/^(?:a|area)$/i,nb=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,ob=/^(?:checked|selected)$/i,
...
(a.defaultValue=b,c):ta&&ta.set(a,b,d)}});Da||(ta=h.valHooks.button={get:function(a,b){var d=a.getAttributeNode(b);return d&&("id"===b||"name"===b||"coords"===b?""!==d.value:d.specified)?d.value:c},set:function(a,b,d){var e=a.getAttributeNode(d);return e||a.setAttributeNode(e=a.ownerDocument.createAttribute(d)),e.value=b+="","value"===d||b===a.getAttribute(d)?b:c}},h.attrHooks.contenteditable={get:ta.get,set:function(a,c,b){ta.set(a,""===c?!1:c,b)}},h.each(["width","height"],function(a,b){h.attrHooks[b]=
...
a.checked=0<=h.inArray(h(a).val(),b):c}})});var qb=/^(?:input|select|textarea)$/i,Ma=/^key/,Qb=/^(?:mouse|contextmenu)|click/,Hb=/^(?:focusinfocus|focusoutblur)$/,Ib=/^([^.]*)(?:\.(.+)|)$/;h.event={global:{},add:function(a,b,d,e,f){var g,p,j,k,q,u,l,n,m;if(j=h._data(a)){d.handler&&(k=d,d=k.handler,f=k.selector);d.guid||(d.guid=h.guid++);(p=j.events)||(p=j.events={});(q=j.handle)||(q=j.handle=function(a){return typeof h===U||a&&h.event.triggered===a.type?c:h.event.dispatch.apply(q.elem,arguments)},
q.elem=a);b=(b||"").match(xa)||[""];for(j=b.length;j--;)g=Ib.exec(b[j])||[],n=u=g[1],m=(g[2]||"").split(".").sort(),g=h.event.special[n]||{},n=(f?g.delegateType:g.bindType)||n,g=h.event.special[n]||{},u=h.extend({type:n,origType:u,data:e,handler:d,guid:d.guid,selector:f,needsContext:f&&h.expr.match.needsContext.test(f),namespace:m.join(".")},k),(l=p[n])||(l=p[n]=[],l.delegateCount=0,g.setup&&!1!==g.setup.call(a,e,m,q)||(a.addEventListener?a.addEventListener(n,q,!1):a.attachEvent&&a.attachEvent("on"+
n,q))),g.add&&(g.add.call(a,u),u.handler.guid||(u.handler.guid=d.guid)),f?l.splice(l.delegateCount++,0,u):l.push(u),h.event.global[n]=!0;a=null}},remove:function(a,c,b,d,e){var f,g,p,j,k,q,u,l,n,m,R,y=h.hasData(a)&&h._data(a);if(y&&(q=y.events)){c=(c||"").match(xa)||[""];for(k=c.length;k--;)if(p=Ib.exec(c[k])||[],n=R=p[1],m=(p[2]||"").split(".").sort(),n){u=h.event.special[n]||{};n=(d?u.delegateType:u.bindType)||n;l=q[n]||[];p=p[2]&&RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)");for(j=f=l.length;f--;)g=
l[f],!e&&R!==g.origType||b&&b.guid!==g.guid||p&&!p.test(g.namespace)||d&&d!==g.selector&&("**"!==d||!g.selector)||(l.splice(f,1),g.selector&&l.delegateCount--,u.remove&&u.remove.call(a,g));j&&!l.length&&(u.teardown&&!1!==u.teardown.call(a,m,y.handle)||h.removeEvent(a,n,y.handle),delete q[n])}else for(n in q)h.event.remove(a,n+c[k],b,d,!0);h.isEmptyObject(q)&&(delete y.handle,h._removeData(a,"events"))}},trigger:function(b,d,e,f){var g,p,j,k,q,u,l=[e||D],n=L.call(b,"type")?b.type:b;u=L.call(b,"namespace")?
...
hb=function(){var a,c=[];return a=function(b,d){return c.push(b+=" ")>W.cacheLength&&delete a[c.shift()],a[b]=d}},ua=function(a){return a[ha]=!0,a},wa=function(a){var c=va.createElement("div");try{return a(c)}catch(b){return!1}finally{}},V=function(a,c,b,d){var e,h,f,g,p;if((c?c.ownerDocument||c:ib)!==va&&sb(c),c=c||va,b=b||[],!a||"string"!=typeof a)return b;if(1!==(g=c.nodeType)&&9!==g)return[];if(!Ja&&!d){if(e=Wc.exec(a))if(f=e[1])if(9===g){if(h=c.getElementById(f),!h||!h.parentNode)return b;if(h.id===
f)return b.push(h),b}else{if(c.ownerDocument&&(h=c.ownerDocument.getElementById(f))&&Jb(c,h)&&h.id===f)return b.push(h),b}else{if(e[2])return tb.apply(b,ub.call(c.getElementsByTagName(a),0)),b;if((f=e[3])&&ka.getByClassName&&c.getElementsByClassName)return tb.apply(b,ub.call(c.getElementsByClassName(f),0)),b}if(ka.qsa&&!Na.test(a)){if(e=!0,h=ha,f=c,p=9===g&&a,1===g&&"object"!==c.nodeName.toLowerCase()){g=Sa(a);(e=c.getAttribute("id"))?h=e.replace(Xc,"\\$&"):c.setAttribute("id",h);h="[id='"+h+"'] ";
...
c.nodeName.toLowerCase();return("input"===b||"button"===b)&&c.type===a}},Ka=function(a){return ua(function(c){return c=+c,ua(function(b,d){for(var e,h=a([],b.length,c),f=h.length;f--;)b[e=h[f]]&&(b[e]=!(d[e]=b[e]))})})},Sa=function(a,c){var b,d,e,h,f,g,p;if(f=uc[a+" "])return c?0:f.slice(0);f=a;g=[];for(p=W.preFilter;f;){(!b||(d=Yc.exec(f)))&&(d&&(f=f.slice(d[0].length)||f),g.push(e=[]));b=!1;(d=Zc.exec(f))&&(b=d.shift(),e.push({value:b,type:d[0].replace(Rb," ")}),f=f.slice(b.length));for(h in W.filter)!(d=
...
c.nodeType||e)if(j=c[ha]||(c[ha]={}),(p=j[d])&&p[0]===k){if(!0===(g=p[1])||g===Tb)return!0===g}else if(p=j[d]=[k],p[1]=a(c,b,f)||Tb,!0===p[1])return!0}},Ub=function(a){return 1<a.length?function(c,b,d){for(var e=a.length;e--;)if(!a[e](c,b,d))return!1;return!0}:a[0]},Kb=function(a,c,b,d,e){for(var h,f=[],g=0,p=a.length,j=null!=c;p>g;g++)(h=a[g])&&(!b||b(h,d,e))&&(f.push(h),j&&c.push(g));return f},Za=function(a,c,b,d,e,h){return d&&!d[ha]&&(d=Za(d)),e&&!e[ha]&&(e=Za(e,h)),ua(function(h,f,g,p){var j,
k,q=[],u=[],n=f.length,l;if(!(l=h)){l=c||"*";for(var m=g.nodeType?[g]:g,R=[],y=0,Ba=m.length;Ba>y;y++)V(l,m[y],R);l=R}l=!a||!h&&c?l:Kb(l,q,a,g,p);m=b?e||(h?a:n||d)?[]:f:l;if(b&&b(l,m,g,p),d){j=Kb(m,u);d(j,[],g,p);for(g=j.length;g--;)(k=j[g])&&(m[u[g]]=!(l[u[g]]=k))}if(h){if(e||a){if(e){j=[];for(g=m.length;g--;)(k=m[g])&&j.push(l[g]=k);e(null,m=[],j,p)}for(g=m.length;g--;)(k=m[g])&&-1<(j=e?ec.call(h,k):q[g])&&(h[j]=!(f[j]=k))}}else m=Kb(m===f?m.splice(n,m.length):m),e?e(null,f,m,p):tb.apply(f,m)})},
fc=function(a){var c,b,d,e=a.length,h=W.relative[a[0].type];b=h||W.relative[" "];for(var f=h?1:0,g=yb(function(a){return a===c},b,!0),p=yb(function(a){return-1<ec.call(c,a)},b,!0),j=[function(a,b,d){return!h&&(d||b!==Vb)||((c=b).nodeType?g(a,b,d):p(a,b,d))}];e>f;f++)if(b=W.relative[a[f].type])j=[yb(Ub(j),b)];else{if(b=W.filter[a[f].type].apply(null,a[f].matches),b[ha]){for(d=++f;e>d&&!W.relative[a[d].type];d++);return Za(1<f&&Ub(j),1<f&&vb(a.slice(0,f-1)).replace(Rb,"$1"),b,d>f&&fc(a.slice(f,d)),
e>d&&fc(a=a.slice(d)),e>d&&vb(a))}j.push(b)}return Ub(j)},vc=function(){},zb,Tb,W,Wb,wc,dc,Ab,Vb,sb,va,Ea,Ja,Na,Bb,Xb,Jb,gc,ha="sizzle"+-new Date,ib=rb.document,ka={},Oa=0,$c=0,xc=hb(),uc=hb(),yc=hb(),tc=-2147483648,Yb=[],ad=Yb.pop,tb=Yb.push,ub=Yb.slice,ec=Yb.indexOf||function(a){for(var c=0,b=this.length;b>c;c++)if(this[c]===a)return c;return-1},zc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Ac="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+
...
a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};sb=V.setDocument=function(a){var c=a?a.ownerDocument||a:ib;if(c!==va&&9===c.nodeType&&c.documentElement){va=c;Ea=c.documentElement;Ja=wc(c);ka.tagNameNoComments=wa(function(a){return a.appendChild(c.createComment("")),!a.getElementsByTagName("*").length});ka.attributes=wa(function(a){a.innerHTML="<select></select>";a=typeof a.lastChild.getAttribute("multiple");return"boolean"!==a&&"string"!==a});ka.getByClassName=wa(function(a){return a.innerHTML=
"<div class='hidden e'></div><div class='hidden'></div>",a.getElementsByClassName&&a.getElementsByClassName("e").length?(a.lastChild.className="e",2===a.getElementsByClassName("e").length):!1});ka.getByName=wa(function(a){a.id=ha+0;a.innerHTML="<a name='"+ha+"'></a><div name='"+ha+"'></div>";Ea.insertBefore(a,Ea.firstChild);var b=c.getElementsByName&&c.getElementsByName(ha).length===2+c.getElementsByName(ha+0).length;return ka.getIdNotName=!c.getElementById(ha),Ea.removeChild(a),b});W.attrHandle=
wa(function(a){return a.innerHTML="<a href='#'></a>",a.firstChild&&"undefined"!==typeof a.firstChild.getAttribute&&"#"===a.firstChild.getAttribute("href")})?{}:{href:function(a){return a.getAttribute("href",2)},type:function(a){return a.getAttribute("type")}};ka.getIdNotName?(W.find.ID=function(a,c){if("undefined"!==typeof c.getElementById&&!Ja){var b=c.getElementById(a);return b&&b.parentNode?[b]:[]}},W.filter.ID=function(a){var c=a.replace(Xa,Ya);return function(a){return a.getAttribute("id")===
c}}):(W.find.ID=function(a,c){if("undefined"!==typeof c.getElementById&&!Ja){var b=c.getElementById(a);return b?b.id===a||"undefined"!==typeof b.getAttributeNode&&b.getAttributeNode("id").value===a?[b]:void 0:[]}},W.filter.ID=function(a){var c=a.replace(Xa,Ya);return function(a){return(a="undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id"))&&a.value===c}});W.find.TAG=ka.tagNameNoComments?function(a,c){return"undefined"!==typeof c.getElementsByTagName?c.getElementsByTagName(a):void 0}:
function(a,c){var b,d=[],e=0,h=c.getElementsByTagName(a);if("*"===a){for(;b=h[e++];)1===b.nodeType&&d.push(b);return d}return h};W.find.NAME=ka.getByName&&function(a,c){return"undefined"!==typeof c.getElementsByName?c.getElementsByName(name):void 0};W.find.CLASS=ka.getByClassName&&function(a,c){return"undefined"===typeof c.getElementsByClassName||Ja?void 0:c.getElementsByClassName(a)};Bb=[];Na=[":focus"];(ka.qsa=ic.test(c.querySelectorAll+""))&&(wa(function(a){a.innerHTML="<select><option selected=''></option></select>";
a.querySelectorAll("[selected]").length||Na.push("\\[[\\x20\\t\\r\\n\\f]*(?:checked|disabled|ismap|multiple|readonly|selected|value)");a.querySelectorAll(":checked").length||Na.push(":checked")}),wa(function(a){a.innerHTML="<input type='hidden' i=''/>";a.querySelectorAll("[i^='']").length&&Na.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:\"\"|'')");a.querySelectorAll(":enabled").length||Na.push(":enabled",":disabled");a.querySelectorAll("*,:x");Na.push(",.*:")}));a=ka;var b;b=Xb=Ea.matchesSelector||Ea.mozMatchesSelector||
Ea.webkitMatchesSelector||Ea.oMatchesSelector||Ea.msMatchesSelector;b=ic.test(b+"");a=((a.matchesSelector=b)&&wa(function(a){ka.disconnectedMatch=Xb.call(a,"div");Xb.call(a,"[s!='']:x");Bb.push("!=",hc)}),Na=RegExp(Na.join("|")),Bb=RegExp(Bb.join("|")),Jb=ic.test(Ea.contains+"")||Ea.compareDocumentPosition?function(a,c){var b=9===a.nodeType?a.documentElement:a,d=c&&c.parentNode;return a===d||!(!d||1!==d.nodeType||!(b.contains?b.contains(d):a.compareDocumentPosition&&16&a.compareDocumentPosition(d)))}:
...
b);for(d=a;d=d.parentNode;)f.unshift(d);for(d=b;d=d.parentNode;)g.unshift(d);for(;f[e]===g[e];)e++;return e?wb(f[e],g[e]):f[e]===ib?-1:g[e]===ib?1:0},Ab=!1,[0,0].sort(gc),ka.detectDuplicates=Ab,va)}else a=va;return a};V.matches=function(a,c){return V(a,null,null,c)};V.matchesSelector=function(a,c){if((a.ownerDocument||a)!==va&&sb(a),c=c.replace(fd,"='$1']"),!(!ka.matchesSelector||Ja||Bb&&Bb.test(c)||Na.test(c)))try{var b=Xb.call(a,c);if(b||ka.disconnectedMatch||a.document&&11!==a.document.nodeType)return b}catch(d){}return 0<
V(c,va,null,[a]).length};V.contains=function(a,c){return(a.ownerDocument||a)!==va&&sb(a),Jb(a,c)};V.attr=function(a,c){var b;return(a.ownerDocument||a)!==va&&sb(a),Ja||(c=c.toLowerCase()),(b=W.attrHandle[c])?b(a):Ja||ka.attributes?a.getAttribute(c):((b=a.getAttributeNode(c))||a.getAttribute(c))&&!0===a[c]?c:b&&b.specified?b.value:null};V.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};V.uniqueSort=function(a){var c,b=[],d=1,e=0;if(Ab=!ka.detectDuplicates,a.sort(gc),Ab){for(;c=
...
!g;if(n){if(h){for(;b;){for(k=c;k=k[b];)if(g?k.nodeName.toLowerCase()===da:1===k.nodeType)return!1;l=b="only"===a&&!l&&"nextSibling"}return!0}if(l=[f?n.firstChild:n.lastChild],f&&p){p=n[ha]||(n[ha]={});j=p[a]||[];u=j[0]===Oa&&j[1];q=j[0]===Oa&&j[2];for(k=u&&n.childNodes[u];k=++u&&k&&k[b]||(q=u=0)||l.pop();)if(1===k.nodeType&&++q&&k===c){p[a]=[Oa,u,q];break}}else if(p&&(j=(c[ha]||(c[ha]={}))[a])&&j[0]===Oa)q=j[1];else for(;(k=++u&&k&&k[b]||(q=u=0)||l.pop())&&(!(g?k.nodeName.toLowerCase()===da:1===
k.nodeType)||!++q||!(p&&((k[ha]||(k[ha]={}))[a]=[Oa,q]),k===c)););return q-=e,q===d||0===q%d&&0<=q/d}}},PSEUDO:function(a,c){var b,d=W.pseudos[a]||W.setFilters[a.toLowerCase()]||V.error("unsupported pseudo: "+a);return d[ha]?d(c):1<d.length?(b=[a,a,"",c],W.setFilters.hasOwnProperty(a.toLowerCase())?ua(function(a,b){for(var e,h=d(a,c),f=h.length;f--;)e=ec.call(a,h[f]),a[e]=!(b[e]=h[f])}):function(a){return d(a,0,b)}):d}},pseudos:{not:ua(function(a){var c=[],b=[],d=dc(a.replace(Rb,"$1"));return d[ha]?
ua(function(a,c,b,e){var h;b=d(a,null,e,[]);for(e=a.length;e--;)(h=b[e])&&(a[e]=!(c[e]=h))}):function(a,e,h){return c[0]=a,d(c,null,h,b),!b.pop()}}),has:ua(function(a){return function(c){return 0<V(a,c).length}}),contains:ua(function(a){return function(c){return-1<(c.textContent||c.innerText||Wb(c)).indexOf(a)}}),lang:ua(function(a){return cd.test(a||"")||V.error("unsupported lang: "+a),a=a.replace(Xa,Ya).toLowerCase(),function(c){var b;do if(b=Ja?c.getAttribute("xml:lang")||c.getAttribute("lang"):
c.lang)return b=b.toLowerCase(),b===a||0===b.indexOf(a+"-");while((c=c.parentNode)&&1===c.nodeType);return!1}}),target:function(a){var c=rb.location&&rb.location.hash;return c&&c.slice(1)===a.id},root:function(a){return a===Ea},focus:function(a){return a===va.activeElement&&(!va.hasFocus||va.hasFocus())&&!(!a.type&&!a.href&&!~a.tabIndex)},enabled:function(a){return!1===a.disabled},disabled:function(a){return!0===a.disabled},checked:function(a){var c=a.nodeName.toLowerCase();return"input"===c&&!!a.checked||
...
checkbox:!0,file:!0,password:!0,image:!0})W.pseudos[zb]=xb(zb);for(zb in{submit:!0,reset:!0})W.pseudos[zb]=Ta(zb);dc=V.compile=function(a,c){var b,d=[],e=[],h=yc[a+" "];if(!h){c||(c=Sa(a));for(b=c.length;b--;)h=fc(c[b]),h[ha]?d.push(h):e.push(h);var f=0,g=0<d.length,p=0<e.length;b=function(a,c,b,h,j){var k,Q,q=[],u=0,l="0",n=a&&[],m=null!=j,da=Vb,R=a||p&&W.find.TAG("*",j&&c.parentNode||c),y=Oa+=null==da?1:Math.random()||0.1;for(m&&(Vb=c!==va&&c,Tb=f);null!=(j=R[l]);l++){if(p&&j){for(k=0;Q=e[k++];)if(Q(j,
c,b)){h.push(j);break}m&&(Oa=y,Tb=++f)}g&&((j=!Q&&j)&&u--,a&&n.push(j))}if(u+=l,g&&l!==u){for(k=0;Q=d[k++];)Q(n,q,c,b);if(a){if(0<u)for(;l--;)n[l]||q[l]||(q[l]=ad.call(h));q=Kb(q)}tb.apply(h,q);m&&!a&&0<q.length&&1<u+d.length&&V.uniqueSort(h)}return m&&(Oa=y,Vb=da),n};b=g?ua(b):b;h=yc(a,b)}return h};W.pseudos.nth=W.pseudos.eq;W.filters=vc.prototype=W.pseudos;W.setFilters=new vc;sb();V.attr=h.attr;h.find=V;h.expr=V.selectors;h.expr[":"]=h.expr.pseudos;h.unique=V.uniqueSort;h.text=V.getText;h.isXMLDoc=
...
this.nextSibling,b=this.parentNode;b&&(h(this).remove(),b.insertBefore(a,c))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,b,d){a=ba.apply([],a);var e,f,g,p,j=0,k=this.length,q=this,u=k-1,l=a[0],m=h.isFunction(l);if(m||!(1>=k||"string"!=typeof l||h.support.checkClone)&&nd.test(l))return this.each(function(e){var h=q.eq(e);m&&(a[0]=l.call(this,e,b?h.html():c));h.domManip(a,b,d)});if(k&&(p=h.buildFragment(a,this[0].ownerDocument,!1,this),e=p.firstChild,1===p.childNodes.length&&
...
"throws":!0}):h.globalEval((e.text||e.textContent||e.innerHTML||"").replace(od,"")))}p=e=null}return this}});h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,c){h.fn[a]=function(a){for(var b=0,d=[],e=h(a),f=e.length-1;f>=b;b++)a=b===f?this:this.clone(!0),h(e[b])[c](a),pa.apply(d,a.get());return this.pushStack(d)}});h.extend({clone:function(a,c,b){var d,e,f,g,p,j=h.contains(a.ownerDocument,a);if(h.support.html5Clone||h.isXMLDoc(a)||
...
F(d,!j&&n(a,"script")),f},buildFragment:function(a,c,b,d){for(var e,f,g,p,j,k,q,u=a.length,l=w(c),m=[],R=0;u>R;R++)if(f=a[R],f||0===f)if("object"===h.type(f))h.merge(m,f.nodeType?[f]:f);else if(ld.test(f)){p=p||l.appendChild(c.createElement("div"));j=(Ec.exec(f)||["",""])[1].toLowerCase();q=Ha[j]||Ha._default;p.innerHTML=q[1]+f.replace(Dc,"<$1></$2>")+q[2];for(e=q[0];e--;)p=p.lastChild;if(!h.support.leadingWhitespace&&jc.test(f)&&m.push(c.createTextNode(jc.exec(f)[0])),!h.support.tbody)for(e=(f="table"!==
j||Fc.test(f)?"<table>"!==q[1]||Fc.test(f)?0:p:p.firstChild)&&f.childNodes.length;e--;)h.nodeName(k=f.childNodes[e],"tbody")&&!k.childNodes.length&&f.removeChild(k);h.merge(m,p.childNodes);for(p.textContent="";p.firstChild;)p.removeChild(p.firstChild);p=l.lastChild}else m.push(c.createTextNode(f));p&&l.removeChild(p);h.support.appendChecked||h.grep(n(m,"input"),M);for(R=0;f=m[R++];)if((!d||-1===h.inArray(f,d))&&(g=h.contains(f.ownerDocument,f),p=n(l.appendChild(f),"script"),g&&F(p),b))for(e=0;f=p[e++];)Gc.test(f.type||
...
arguments.length?this.on(b,null,a,c):this.trigger(b)}});h.fn.hover=function(a,b){return this.mouseenter(a).mouseleave(b||a)};var jb,$a,mc=h.now(),nc=/\?/,xd=/#.*$/,Kc=/([?&])_=[^&]*/,yd=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,zd=/^(?:GET|HEAD)$/,Ad=/^\/\//,Lc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Mc=h.fn.load,Nc={},bc={},Oc="*/".concat("*");try{$a=na.href}catch(Gd){$a=D.createElement("a"),$a.href="",$a=$a.href}jb=Lc.exec($a.toLowerCase())||[];h.fn.load=function(a,b,d){if("string"!=typeof a&&Mc)return Mc.apply(this,
...
{state:"parsererror",error:w?A:"No conversion from "+z+" to "+O};break a}}z=O}D={state:"success",data:u}}u=D;r=u.state;O=u.data;H=u.error;u=!H}else H=r,(a||!r)&&(r="error",0>a&&(a=0));x.status=a;x.statusText=(b||r)+"";u?R.resolveWith(n,[O,r,x]):R.rejectWith(n,[x,r,H]);x.statusCode(Ba);Ba=c;k&&m.trigger(u?"ajaxSuccess":"ajaxError",[x,l,u?O:H]);y.fireWith(n,[x,r]);k&&(m.trigger("ajaxComplete",[x,l]),--h.active||h.event.trigger("ajaxStop"))}}"object"==typeof a&&(b=a,a=c);b=b||{};var e,f,g,p,j,k,q,u,
l=h.ajaxSetup({},b),n=l.context||l,m=l.context&&(n.nodeType||n.jquery)?h(n):h.event,R=h.Deferred(),y=h.Callbacks("once memory"),Ba=l.statusCode||{},O={},H={},U=0,t="canceled",x={readyState:0,getResponseHeader:function(a){var b;if(2===U){if(!u)for(u={};b=yd.exec(p);)u[b[1].toLowerCase()]=b[2];b=u[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===U?p:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return U||(a=H[c]=H[c]||a,O[a]=b),this},overrideMimeType:function(a){return U||
(l.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>U)for(b in a)Ba[b]=[Ba[b],a[b]];else x.always(a[x.status]);return this},abort:function(a){a=a||t;return q&&q.abort(a),d(0,a),this}};if(R.promise(x).complete=y.add,x.success=x.done,x.error=x.fail,l.url=((a||l.url||$a)+"").replace(xd,"").replace(Ad,jb[1]+"//"),l.type=b.method||b.type||l.method||l.type,l.dataTypes=h.trim(l.dataType||"*").toLowerCase().match(xa)||[""],null==l.crossDomain&&(e=Lc.exec(l.url.toLowerCase()),l.crossDomain=!(!e||e[1]===
...
2===U))return x.abort();t="abort";for(f in{success:1,error:1,complete:1})x[f](l[f]);if(q=Y(bc,l,b,x)){x.readyState=1;k&&m.trigger("ajaxSend",[x,l]);l.async&&0<l.timeout&&(j=setTimeout(function(){x.abort("timeout")},l.timeout));try{U=1,q.send(O,d)}catch(r){if(!(2>U))throw r;d(-1,r)}}else d(-1,"No Transport");return x},getScript:function(a,b){return h.get(a,c,b,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
"string"==typeof j.responseText&&(l.text=j.responseText);try{q=j.statusText}catch(u){q=""}p||!b.isLocal||b.crossDomain?1223===p&&(p=204):p=l.text?200:404}}catch(n){e||f(-1,n)}l&&f(p,q,l,k)};b.async?4===j.readyState?setTimeout(d):(g=++Bd,pc&&(Cb||(Cb={},h(a).unload(pc)),Cb[g]=d),j.onreadystatechange=d):d()},abort:function(){d&&d(c,!0)}}}});var kb,Zb,Cd=/^(?:toggle|show|hide)$/,Dd=RegExp("^(?:([+-])=|)("+za+")([a-z%]*)$","i"),Ed=/queueHooks$/,Nb=[function(a,b,c){var d,e,f,g,p,j,k=this,q=a.style,l={},
...
u[e],g=k.createTween(d,n?f[d]:0),l[d]=f[d]||h.style(a,d),d in f||(f[d]=g.start,n&&(g.end=g.start,g.start="width"===d||"height"===d?1:0))}}],Eb={"*":[function(a,b){var c,d,e=this.createTween(a,b),f=Dd.exec(b),g=e.cur(),p=+g||0,j=1,k=20;if(f){if(c=+f[2],d=f[3]||(h.cssNumber[a]?"":"px"),"px"!==d&&p){p=h.css(e.elem,a,!0)||c||1;do j=j||".5",p/=j,h.style(e.elem,a,p+d);while(j!==(j=e.cur()/g)&&1!==j&&--k)}e.unit=d;e.start=p;e.end=f[1]?p+(f[1]+1)*c:c}return e}]};h.Animation=h.extend(E,{tweener:function(a,
b){h.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,d=0,e=a.length;e>d;d++)c=a[d],Eb[c]=Eb[c]||[],Eb[c].unshift(b)},prefilter:function(a,b){b?Nb.unshift(a):Nb.push(a)}});h.Tween=K;K.prototype={constructor:K,init:function(a,b,c,d,e,f){this.elem=a;this.prop=c;this.easing=e||"swing";this.options=b;this.start=this.now=this.cur();this.end=d;this.unit=f||(h.cssNumber[c]?"":"px")},cur:function(){var a=K.propHooks[this.prop];return a&&a.get?a.get(this):K.propHooks._default.get(this)},run:function(a){var b,
...
a,d,e)}});h.fn.extend({fadeTo:function(a,b,c,d){return this.filter(B).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){var e=h.isEmptyObject(a),f=h.speed(b,c,d),g=function(){var b=E(this,h.extend({},a),f);g.finish=function(){b.stop(!0)};(e||h._data(this,"finish"))&&b.stop(!0)};return g.finish=g,e||!1===f.queue?this.each(g):this.queue(f.queue,g)},stop:function(a,b,d){var e=function(a){var b=a.stop;delete a.stop;b(d)};return"string"!=typeof a&&(d=b,b=a,a=c),b&&!1!==
...
h.fn.offset=function(a){if(arguments.length)return a===c?this:this.each(function(b){h.offset.setOffset(this,a,b)});var b,d,e={top:0,left:0},f=this[0],g=f&&f.ownerDocument;if(g)return b=g.documentElement,h.contains(b,f)?(typeof f.getBoundingClientRect!==U&&(e=f.getBoundingClientRect()),d=H(g),{top:e.top+(d.pageYOffset||b.scrollTop)-(b.clientTop||0),left:e.left+(d.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}):e};h.offset={setOffset:function(a,b,c){var d=h.css(a,"position");"static"===d&&(a.style.position=
...
g){function v(){return b||!0!==m.options.disabled&&!a(this).hasClass("ui-state-disabled")?("string"==typeof g?m[g]:g).apply(m,arguments):c}"string"!=typeof g&&(v.guid=g.guid=g.guid||v.guid||a.guid++);var r=e.match(/^(\w+)\s*(.*)$/),F=r[1]+m.eventNamespace;(r=r[2])?j.delegate(r,F,v):d.bind(F,v)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"==typeof a?
...
isWindow:c,offset:b.offset()||{left:0,top:0},scrollLeft:b.scrollLeft(),scrollTop:b.scrollTop(),width:c?b.width():b.outerWidth(),height:c?b.height():b.outerHeight()}}};a.fn.position=function(c){if(!c||!c.of)return v.apply(this,arguments);c=a.extend({},c);var d,n,l,z,r,w,X=a(c.of),M=a.position.getWithinInfo(c.within),t=a.position.getScrollInfo(M),A=(c.collision||"flip").split(" "),F={},S=X,Z=S[0];return w=9===Z.nodeType?{width:S.width(),height:S.height(),offset:{top:0,left:0}}:a.isWindow(Z)?{width:S.width(),
...
top:e.top,left:e.left})})},drag:function(c,b){var d,e,f,k,g,j,m,s,w,v,r=a(this).data("ui-draggable"),F=r.options,A=F.snapTolerance,n=b.offset.left,M=n+r.helperProportions.width,x=b.offset.top,B=x+r.helperProportions.height;for(w=r.snapElements.length-1;0<=w;w--)g=r.snapElements[w].left,j=g+r.snapElements[w].width,m=r.snapElements[w].top,s=m+r.snapElements[w].height,g-A>M||n>j+A||m-A>B||x>s+A||!a.contains(r.snapElements[w].item.ownerDocument,r.snapElements[w].item)?(r.snapElements[w].snapping&&r.options.snap.release&&
r.options.snap.release.call(r.element,c,a.extend(r._uiHash(),{snapItem:r.snapElements[w].item})),r.snapElements[w].snapping=!1):("inner"!==F.snapMode&&(d=A>=Math.abs(m-B),e=A>=Math.abs(s-x),f=A>=Math.abs(g-M),k=A>=Math.abs(j-n),d&&(b.position.top=r._convertPositionTo("relative",{top:m-r.helperProportions.height,left:0}).top-r.margins.top),e&&(b.position.top=r._convertPositionTo("relative",{top:s,left:0}).top-r.margins.top),f&&(b.position.left=r._convertPositionTo("relative",{top:0,left:g-r.helperProportions.width}).left-
r.margins.left),k&&(b.position.left=r._convertPositionTo("relative",{top:0,left:j}).left-r.margins.left)),v=d||e||f||k,"outer"!==F.snapMode&&(d=A>=Math.abs(m-x),e=A>=Math.abs(s-B),f=A>=Math.abs(g-n),k=A>=Math.abs(j-M),d&&(b.position.top=r._convertPositionTo("relative",{top:m,left:0}).top-r.margins.top),e&&(b.position.top=r._convertPositionTo("relative",{top:s-r.helperProportions.height,left:0}).top-r.margins.top),f&&(b.position.left=r._convertPositionTo("relative",{top:0,left:g}).left-r.margins.left),
...
c=b.options,f=b.size,k=b.originalSize,g=b.originalPosition,j=b.axis,m="number"==typeof c.grid?[c.grid,c.grid]:c.grid,s=m[0]||1,w=m[1]||1,v=Math.round((f.width-k.width)/s)*s,f=Math.round((f.height-k.height)/w)*w,r=k.width+v,k=k.height+f,F=c.maxWidth&&r>c.maxWidth,A=c.maxHeight&&k>c.maxHeight,n=c.minWidth&&c.minWidth>r,M=c.minHeight&&c.minHeight>k;c.grid=m;n&&(r+=s);M&&(k+=w);F&&(r-=s);A&&(k-=w);/^(se|s|e)$/.test(j)?(b.size.width=r,b.size.height=k):/^(ne)$/.test(j)?(b.size.width=r,b.size.height=k,b.position.top=
...
!I.showInput);u.toggleClass("sp-alpha-enabled",I.showAlpha);u.toggleClass("sp-buttons-disabled",!I.showButtons||E);u.toggleClass("sp-palette-disabled",!I.showPalette);u.toggleClass("sp-palette-only",I.showPaletteOnly);u.toggleClass("sp-initial-disabled",!I.showInitial);u.addClass(I.className);N()},n=function(b){if(Y&&(b=tinycolor(b).toRgbString(),-1===c.inArray(b,Fa)&&Fa.push(b),ca&&a.localStorage))try{a.localStorage[ca]=Fa.join(";")}catch(d){}},y=function(){var a=[],b=Fa,c={},d;if(I.showPalette){for(var e=
0;e<gb.length;e++)for(var f=0;f<gb[e].length;f++)d=tinycolor(gb[e][f]).toRgbString(),c[d]=!0;for(e=0;e<b.length;e++)d=tinycolor(b[e]).toRgbString(),c.hasOwnProperty(d)||(a.push(b[e]),c[d]=!0)}return a.reverse().slice(0,I.maxSelectionSize)},H=function(){var a=x(),b=c.map(gb,function(b,c){return d(b,a,"sp-palette-row sp-palette-row-"+c)});Fa&&b.push(d(y(),a,"sp-palette-row sp-palette-row-selection"));Qb.html(b.join(""))},r=function(){if(I.showInitial){var a=Ta,b=x();Hb.html(d([a,b],b,"sp-palette-row-initial"))}},
t=function(){(0===ea||0===aa||0===ia)&&N();u.addClass(sa)},U=function(){u.removeClass(sa)},O=function(){var a=tinycolor(Ma.val());a.ok?h(a):Ma.addClass("sp-validation-error")},X=function(){Aa?D():z()},z=function(){if(Aa)N();else if(!1!==G.beforeShow(x())){for(var b=0;b<s.length;b++)s[b]&&s[b].hide();Aa=!0;c(ta).bind("click.spectrum",D);c(a).bind("resize.spectrum",S);wa.addClass("sp-active");u.show();I.showPalette&&H();N();M();Ta=x();r();G.show(Ta)}},D=function(b){if((!b||!("click"==b.type&&2==b.button))&&
Aa&&!E)Aa=!1,c(ta).unbind("click.spectrum",D),c(a).unbind("resize.spectrum",S),wa.removeClass("sp-active"),u.hide(),tinycolor.equals(x(),Ta)||(vb&&"cancel"!==b?B(!0):h(Ta,!0)),G.hide(x())},h=function(a,b){if(!tinycolor.equals(a,x())){var c=tinycolor(a),d=c.toHsv();ga=d.h;La=d.s;ma=d.v;J=d.a;M();b||(Sa=Ka||c.format)}},x=function(){return tinycolor.fromRatio({h:ga,s:La,v:ma,a:Math.round(100*J)/100})},A=function(){M();G.move(x())},M=function(){Ma.removeClass("sp-validation-error");T();var a=tinycolor({h:ga,
...
nb.width();ia=nb.height();Ga=ob.height();ja=pb.width();qa=qb.width();E||u.offset(e(u,V));T()};q=function(){D();p=!0;ra.attr("disabled",!0);V.addClass("sp-disabled")};var I,C=c.extend({},m,f);C.callbacks={move:g(C.move,this),change:g(C.change,this),show:g(C.show,this),hide:g(C.hide,this),beforeShow:g(C.beforeShow,this)};I=C;var E=I.flat,Y=I.showSelectionPalette,ca=I.localStorageKey,K=I.theme,G=I.callbacks,S,Z=N,fb;S=function(){var a=this,b=arguments;fb||(fb=setTimeout(function(){fb=null;Z.apply(a,
b)},10))};var Aa=!1,aa=0,ea=0,P=0,ia=0,ja=0,qa=0,Ga=0,ga=0,La=0,ma=0,J=1,C=I.palette.slice(0),gb=c.isArray(C[0])?C:[C],Fa=I.selectionPalette.slice(0),sa="sp-dragging",ta=this.ownerDocument,C=ta.body,ra=c(this),p=!1,u=c(F,ta).addClass(K),Ba=u.find(".sp-color"),Ca=u.find(".sp-dragger"),nb=u.find(".sp-hue"),ob=u.find(".sp-slider"),Da=u.find(".sp-alpha-inner"),pb=u.find(".sp-alpha"),qb=u.find(".sp-alpha-handle"),Ma=u.find(".sp-input"),Qb=u.find(".sp-palette"),Hb=u.find(".sp-initial"),Ib=u.find(".sp-cancel"),
rb=u.find(".sp-choose"),hb=ra.is("input"),ua=hb&&!E,wa=ua?c("<div class='sp-replacer'><div class='sp-preview'><div class='sp-preview-inner'></div></div></div>").addClass(K):c([]),V=ua?wa:ra,wb=wa.find(".sp-preview-inner"),xb=I.color||hb&&ra.val(),Ta=!1,Ka=I.preferredFormat,Sa=Ka,vb=!I.showButtons||I.clickoutFiresChange,K=function(a){a.data&&a.data.ignore?(h(c(this).data("color")),A()):(h(c(this).data("color")),B(!0),A(),D());return!1};w&&u.find("*:not(input)").attr("unselectable","on");l();ua&&ra.hide().after(wa);
E?ra.after(u).hide():c(C).append(u.hide());if(ca&&a.localStorage){try{var yb=a.localStorage[ca].split(",#");1<yb.length&&(delete a.localStorage[ca],c.each(yb,function(a,b){n(b)}))}catch(Ub){}try{Fa=a.localStorage[ca].split(";")}catch(Kb){}}V.bind("click.spectrum touchstart.spectrum",function(a){p||X();a.stopPropagation();c(a.target).is("input")||a.preventDefault()});(ra.is(":disabled")||!0===I.disabled)&&q();u.click(k);Ma.change(O);Ma.bind("paste",function(){setTimeout(O,1)});Ma.keydown(function(a){13==
...
e,f){if(b.call(c,a,e,f))return d=a,!0});return d};l.filter=l.select=function(a,b,c){var d=[];if(null==a)return d;if(F&&a.filter===F)return a.filter(b,c);z(a,function(a,e,f){b.call(c,a,e,f)&&(d[d.length]=a)});return d};l.reject=function(a,b,c){var d=[];if(null==a)return d;z(a,function(a,e,f){b.call(c,a,e,f)||(d[d.length]=a)});return d};l.every=l.all=function(a,b,c){var e=!0;if(null==a)return e;if(A&&a.every===A)return a.every(b,c);z(a,function(a,f,g){if(!(e=e&&b.call(c,a,f,g)))return d});return!!e};
var N=l.some=l.any=function(a,b,c){b||(b=l.identity);var e=!1;if(null==a)return e;if(n&&a.some===n)return a.some(b,c);z(a,function(a,f,g){if(e||(e=b.call(c,a,f,g)))return d});return!!e};l.include=l.contains=function(a,b){return null==a?!1:M&&a.indexOf===M?-1!=a.indexOf(b):N(a,function(a){return a===b})};l.invoke=function(a,b){var c=k.call(arguments,2);return l.map(a,function(a){return(l.isFunction(b)?b||a:a[b]).apply(a,c)})};l.pluck=function(a,b){return l.map(a,function(a){return a[b]})};l.max=function(a,
...
(function(){function a(a,b){return"!"!==a[0][0]?'<a href="'+f(b.href)+'"'+(b.title?' title="'+f(b.title)+'"':"")+">"+n.lexer(a[1])+"</a>":'<img src="'+f(b.href)+'" alt="'+f(a[1])+'"'+(b.title?' title="'+f(b.title)+'"':"")+">"}function c(){return x=M.pop()}function b(){switch(x.type){case "space":return"";case "hr":return"<hr>\n";case "heading":return"<h"+x.depth+">"+n.lexer(x.text)+"</h"+x.depth+">\n";case "code":return B.highlight&&(x.code=B.highlight(x.text,x.lang),null!=x.code&&x.code!==x.text&&
...
"";"list_item_end"!==c().type;)a+=b();return"<li>"+a+"</li>\n";case "html":return B.sanitize?n.lexer(x.text):!x.pre&&!B.pedantic?n.lexer(x.text):x.text;case "paragraph":return"<p>"+n.lexer(x.text)+"</p>\n";case "text":return"<p>"+d()+"</p>\n"}}function d(){for(var a=x.text,b;(b=M[M.length-1])&&"text"===b.type;)a+="\n"+c().text;return n.lexer(a)}function e(a){M=a.reverse();for(a="";c();)a+=b();x=M=null;return a}function f(a,b){return a.replace(!b?/&(?!#?\w+;)/g:/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],f=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],g=Array(64),k,F,A,n,M,x,B,C,l,z,N,I;a[c>>5]|=128<<24-c%
32;a[(c+64>>9<<4)+15]=c;for(l=0;l<a.length;l+=16){k=f[0];F=f[1];A=f[2];n=f[3];M=f[4];x=f[5];B=f[6];C=f[7];for(z=0;64>z;z++)g[z]=16>z?a[z+l]:b(b(b(d(g[z-2],17)^d(g[z-2],19)^g[z-2]>>>10,g[z-7]),d(g[z-15],7)^d(g[z-15],18)^g[z-15]>>>3),g[z-16]),N=b(b(b(b(C,d(M,6)^d(M,11)^d(M,25)),M&x^~M&B),e[z]),g[z]),I=b(d(k,2)^d(k,13)^d(k,22),k&F^k&A^F&A),C=B,B=x,x=M,M=b(n,N),n=A,A=F,F=k,k=b(N,I);f[0]=b(k,f[0]);f[1]=b(F,f[1]);f[2]=b(A,f[2]);f[3]=b(n,f[3]);f[4]=b(M,f[4]);f[5]=b(x,f[5]);f[6]=b(B,f[6]);f[7]=b(C,f[7])}return f},
...
e+"(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)","i").exec(c))){if((a=String(d.label||a).split("/"))[1]&&!/[\d.]+/.test(a[0]))a[0]+=" "+a[1];d=d.label||d;a=b(a[0].replace(RegExp(e,"i"),d).replace(RegExp("; *(?:"+d+"[_-])?","i")," ").replace(RegExp("("+d+")(\\w)","i"),"$1 $2"))}return a})}c||(c=I);var t,w=c,B=[],S=null,Z=c==I,E=Z&&l&&"function"==typeof l.version&&l.version(),K=g([{label:"WebKit",pattern:"AppleWebKit"},"iCab","Presto","NetFront","Tasman","Trident","KHTML","Gecko"],function(a,b){return a||
...
"$1").replace(/\/(\d)/," $1").replace(/_/g,".").replace(/(?: BePC|[ .]*fc[ \d.]+)$/i,"").replace(/x86\.64/gi,"x86_64").split(" on ")[0])}return a});K&&(K=[K]);R&&!H&&(H=f([R]));if(t=/Google TV/.exec(H))H=t[0];/\bSimulator\b/i.test(c)&&(H=(H?H+" ":"")+"Simulator");if(/^iP/.test(H))q||(q="Safari"),y="iOS"+((t=/ OS ([\d_]+)/i.exec(c))?" "+t[1].replace(/_/g,"."):"");else if("Konqueror"==q&&!/buntu/i.test(y))y="Kubuntu";else if(R&&"Google"!=R&&/Chrome|Vita/.test(q+";"+H))q="Android Browser",y=/Android/.test(y)?
y:"Android";else if(!q||(t=!/\bMinefield\b/i.test(c)&&/Firefox|Safari/.exec(q)))if(q&&(!H&&/[\/,]|^[^(]+?\)/.test(c.slice(c.indexOf(t+"/")+8)))&&(q=null),(t=H||R||y)&&(H||R||/Android|Symbian OS|Tablet OS|webOS/.test(y)))q=/[a-z]+(?: Hat)?/i.exec(/Android/.test(y)?y:t)+" Browser";E||(E=["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",k(q),"(?:Firefox|Minefield|NetFront)"],E=g(E,function(a,b){return a||(RegExp(b+"(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)","i").exec(c)||
0)[1]||null}));if("iCab"==K&&3<parseFloat(E))K=["WebKit"];else if(t=/Opera/.test(q)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(c)&&"WebKit"||!K&&/\bMSIE\b/i.test(c)&&(/^Mac/.test(y)?"Tasman":"Trident"))K=[t];if(Z){var U=a,D=null!=U?typeof U.global:"number";if(!/^(?:boolean|number|string|undefined)$/.test(D)&&("object"==D?U.global:1))if(A&&(t=A.lang.System,w=t.getProperty("os.arch"),y=y||t.getProperty("os.name")+" "+t.getProperty("os.version")),"object"==typeof exports&&exports)if(N==s&&"object"==
...
"."+t.minor+"."+t.patch;else if("number"==typeof x.documentMode&&(t=/\bTrident\/(\d+)/i.exec(c))){E=[E,x.documentMode];if((t=+t[1]+4)!=E[1])B.push("IE "+E[1]+" mode"),K[1]="",E[1]=t;E="IE"==q?String(E[1].toFixed(1)):E[0]}y=y&&b(y)}if(E&&(t=/(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(E)||/(?:alpha|beta)(?: ?\d)?/i.exec(c+";"+(Z&&C.appMinorVersion))||/\bMinefield\b/i.test(c)&&"a"))S=/b/i.test(t)?"beta":"alpha",E=E.replace(RegExp(t+"\\+?$"),"")+("beta"==S?M:n)+(/\d+\+?/.exec(t)||"");if("Fennec"==
q)q="Firefox Mobile";else if("Maxthon"==q&&E)E=E.replace(/\.[\d.]+/,".x");else if("Silk"==q)/Mobi/i.test(c)||(y="Android",B.unshift("desktop mode")),/Accelerated *= *true/i.test(c)&&B.unshift("accelerated");else if("IE"==q&&(t=(/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(c)||0)[1]))q+=" Mobile",y="Windows Phone OS "+t+".x",B.unshift("desktop mode");else if(("IE"==q||q&&!H&&!/Browser|Mobi/.test(q))&&("Windows CE"==y||/Mobi/i.test(c)))q+=" Mobile";else if("IE"==q&&Z&&"object"==typeof external&&!external)B.unshift("platform preview");
else if(/BlackBerry/.test(H)&&(t=(RegExp(H.replace(/ +/g," *")+"/([.\\d]+)","i").exec(c)||0)[1]||E))y="Device Software "+t,E=null;else if(this!=d&&(Z&&l||/Opera/.test(q)&&/\b(?:MSIE|Firefox)\b/i.test(c)||"Firefox"==q&&/OS X (?:\d+\.){2,}/.test(y)||"IE"==q&&(y&&!/^Win/.test(y)&&5.5<E||/Windows XP/.test(y)&&8<E||8==E&&!/Trident/.test(c)))&&!r.test(t=m.call(d,c.replace(r,"")+";"))&&t.name)t="ing as "+t.name+((t=t.version)?" "+t:""),r.test(q)?(/IE/.test(t)&&"Mac OS"==y&&(y=null),t="identify"+t):(t="mask"+
t,q=z?b(z.replace(/([a-z])([A-Z])/g,"$1 $2")):"Opera",/IE/.test(t)&&(y=null),Z||(E=null)),K=["Presto"],B.push(t);if(t=(/\bAppleWebKit\/([\d.]+\+?)/i.exec(c)||0)[1]){t=[parseFloat(t.replace(/\.(\d)$/,".0$1")),t];if("Safari"==q&&"+"==t[1].slice(-1))q="WebKit Nightly",S="alpha",E=t[1].slice(0,-1);else if(E==t[1]||E==(/\bSafari\/([\d.]+\+?)/i.exec(c)||0)[1])E=null;t=[t[0],(/\bChrome\/([\d.]+)/i.exec(c)||0)[1]];!Z||/internal|\n/i.test(F.toString())&&!t[1]?(K[1]="like Safari",t=(t=t[0],400>t?1:500>t?2:
...
var cssToObject=function(a,c){function b(a){var b=a.match(/\n/g);b&&(z+=b.length);b=a.lastIndexOf("\n");N=~b?a.length-b:N+a.length}function d(){var a={line:z,column:N};return!c.position?e:function(b){b.position={start:a,end:{line:z,column:N}};j(/^\s*/);return b}}function e(a){j(/^\s*/);return a}function f(b){b=Error(b+" near line "+z+":"+N);b.line=z;b.column=N;b.source=a;throw b;}function k(){return j(/^{\s*/)}function g(){var b,c=[];j(/^\s*/);for(m(c);"}"!=a[0]&&(b=A()||(M()||n()||C("import")||C("charset")||
C("namespace")||B()||x())||l());)c.push(b),m(c);return c}function j(c){if(c=c.exec(a)){var d=c[0];b(d);a=a.slice(d.length);return c}}function m(a){var b;for(a=a||[];b=s();)a.push(b);return a}function s(){var c=d();if(!("/"!=a[0]||"*"!=a[1])){for(var e=2;null!=a[e]&&("*"!=a[e]||"/"!=a[e+1]);)++e;var e=e+2,f=a.slice(2,e-2);N+=2;b(f);a=a.slice(e);N+=2;return c({type:"comment",comment:f})}}function w(){var a=j(/^([^{]+)/);if(a)return a[0].trim().split(/\s*,\s*/)}function v(){var a=d(),b=j(/^(\*?[-\w]+)\s*/);
if(b){b=b[0];if(!j(/^:\s*/))return f("property missing ':'");var c=j(/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^\)]*?\)|[^};])+)/);if(!c)return f("property missing value");a=a({type:"declaration",property:b,value:c[0].trim()});j(/^[;\s]*/);return a}}function r(){var a=[];if(!k())return f("missing '{'");m(a);for(var b;b=v();)a.push(b),m(a);return!j(/^}/)?f("missing '}'"):a}function F(){for(var a,b=[],c=d();a=j(/^(from|to|\d+%|\.\d+%|\d+\.\d+%)\s*/);)b.push(a[1]),j(/^,\s*/);if(b.length)return c({type:"keyframe",
values:b,declarations:r()})}function A(){var a=d(),b=j(/^@([-\w]+)?keyframes */);if(b){var c=b[1],b=j(/^([-\w]+)\s*/);if(!b)return f("@keyframes missing name");b=b[1];if(!k())return f("@keyframes missing '{'");for(var e,g=m();e=F();)g.push(e),g=g.concat(m());return!j(/^}/)?f("@keyframes missing '}'"):a({type:"keyframes",name:b,vendor:c,keyframes:g})}}function n(){var a=d(),b=j(/^@supports *([^{]+)/);if(b){b=b[1].trim();if(!k())return f("@supports missing '{'");var c=m().concat(g());return!j(/^}/)?
f("@supports missing '}'"):a({type:"supports",supports:b,rules:c})}}function M(){var a=d(),b=j(/^@media *([^{]+)/);if(b){b=b[1].trim();if(!k())return f("@media missing '{'");var c=m().concat(g());return!j(/^}/)?f("@media missing '}'"):a({type:"media",media:b,rules:c})}}function x(){var a=d();if(j(/^@page */)){var b=w()||[];if(!k())return f("@page missing '{'");for(var c=m(),e;e=v();)c.push(e),c=c.concat(m());return!j(/^}/)?f("@page missing '}'"):a({type:"page",selectors:b,declarations:c})}}function B(){var a=
d(),b=j(/^@([-\w]+)?document *([^{]+)/);if(b){var c=(b[1]||"").trim(),b=b[2].trim();if(!k())return f("@document missing '{'");var e=m().concat(g());return!j(/^}/)?f("@document missing '}'"):a({type:"document",document:b,vendor:c,rules:e})}}function C(a){var b=d(),c=j(RegExp("^@"+a+" *([^;\\n]+);"));if(c){var e={type:a};e[a]=c[1].trim();return b(e)}}function l(){var a=d(),b=w();if(b)return m(),a({type:"rule",selectors:b,declarations:r()})}c=c||{};var z=1,N=1;return{type:"stylesheet",stylesheet:{rules:g()}}},
...
Boston.styleEditor.edit=function(a){$(".handle").remove();var c=$('<div id="BostonStyleEditorModal"/>');c.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});c.on("click",function(){F.trigger("click")});$("body").append(c);var b=a.element(),d=$('<div id="BostonStyleEditor"></div>');d.css({left:b.offset().left+2+"px",top:b.offset().top+b.outerHeight()+4+"px"});b=$('<div id="BostonStyleEditorTopBar"></div>');d.append(b);var e=$('<div class="editorOption selectedEditorOption">Block</div>');
...
b.on("tap",function(){Boston.stage.selection.patch("locked true");F.trigger("click");return!1});f.append(b);var g=$('<select id="nudgepadLinkSelect"></select>'),b=$("<option>No link</option>");b.on("click",function(){Boston.stage.selection.patch("href ")});g.append(b);_.each(Project.values.pages.values,function(a,b){var c=$('<option value="'+b+'">'+ToProperCase(b)+"</option>");c.on("click",function(){Boston.stage.selection.patch("tag a\nhref "+$(this).attr("value"))});g.append(c)});b=$("<option>New Page</option>");
b.on("click",function(){var a=prompt("Enter the name of your new page",Boston.menu.nextName(Boston.stage.activePage));if(a){a=Permalink(a);Boston.stage.selection.patch("tag a\nhref "+a);F.trigger("click");var b=Boston.stage.activePage;Boston.menu.duplicate(null,a,!0);Boston.stage.open(b)}});g.append(b);b=$("<option>External Link</option>");b.on("click",function(){var a=prompt("Enter the url to link to","http://");a&&Boston.stage.selection.patch("tag a\nhref "+a)});g.append(b);g.css({display:"none",
...
a;r.on("keyup",Boston.styleEditor.livePreviewStart);d.append(r);e=$('<div id="BostonStyleEditorBottomBar"></div>');r.append(e);var F=$('<div id="BostonStyleEditorSaveButton">Save</div>');F.on("click",function(){Boston.stage.commit();$(".handle").trigger("update");d.remove();c.remove()});r.append(F);$("body").append(d);var A;$(".colorPicker").spectrum({color:k,move:function(a){Boston.stage.selection.cssPreview("background-color "+a.toHexString());k=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+
...
Boston.on("close",function(){$(document).off("slidestart",Boston.pen.draw);$("#BostonImagesRibbon,#BostonComponentsRibbon").hide();$("#BostonStage,#BostonBar").hide();Boston.off("selection",Boston.broadcastSelection);Screens.off("change",Boston.updateSelections);Screens.off("change",Boston.updateTabs);$("#BostonStage").off("click",Boston.pen.insertTextBlock);Project.off("delete",Boston.updateTabs);Boston.stage.close();if(!navigator.userAgent.match(/iPad|iPhone|iPod/i))return null;$(document).off("touchstart",
Boston.stopPropagation);$(document).off("touchmove",Boston.preventDefault);window.removeEventListener("copy",Boston.oncopy,!1);window.removeEventListener("cut",Boston.oncut,!1);window.removeEventListener("paste",Boston.onpaste,!1);window.removeEventListener("resize",Boston.onresize,!1);$("body").off("keydown",Boston.onkeydown);Events.shortcut.shortcuts={};navigator.userAgent.match(/(iPad|iPhone|iPod)/i)?(document.removeEventListener("touchstart",Boston.Mouse.onTouchStart,!0),document.removeEventListener("touchend",
Boston.Mouse.onTouchEnd,!0),document.removeEventListener("touchmove",Boston.Mouse.onTouchMove,!0)):(document.removeEventListener("mousedown",Boston.Mouse.onmousedown,!0),document.removeEventListener("mousemove",Boston.Mouse.onmousemove,!0),document.removeEventListener("mouseup",Boston.Mouse.onmouseup,!0))});
...
Share.set("description","Share your project for others to remix.");Share.set("beta",!0);Share.on("open",function(){var a='<form method="post" action="http://'+Project.get("hostname")+'/create">',a=a+('<input type="hidden" name="dir" value="/nudgepad/projects/'+document.location.host+'">'),a=a+'<button type="submit">Create</button></form>';$("#ShareCode").val(a)});var __slice=Array.prototype.slice;
