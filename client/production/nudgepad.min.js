...
Blog.publishAll=function(){Explorer.getFolder("posts",function(a){(new Space(a)).each(function(a,d){d=new Space(d.toString());var c=Blog.permalink(a.replace(/\.space/,"")),e=d.get("template");(e=Project.get("pages "+e))||(e=new Space($("#BlogTheme").text()));e=Blog.pressPost(d.toString(),e.toString());Explorer.set(c+".html",e,function(){Flasher.success("published "+c)})})})};
