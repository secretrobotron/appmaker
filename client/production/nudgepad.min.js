...
Blog.getList=function(){Explorer.getFolder("posts",function(a){a=new Space(a);var b=new Space;a.each(function(a,c){c=new Space(c.toString());var e=Blog.permalink(c.get("title")),f=new Space;f.set("tag","a");f.set("href",e);f.set("content",c.get("title"));b.set("scraps "+e,f)});console.log(b.toString())})};Blog.install=function(){Project.get("posts")||Explorer.mkdir("private posts")};Blog.permalink=function(a){return!a?"":a.toLowerCase().replace(/[^a-z0-9- _\.]/gi,"").replace(/ /g,"-")};
